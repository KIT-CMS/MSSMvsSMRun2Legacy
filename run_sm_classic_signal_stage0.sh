...
if [[ $MODE == "initial" ]]; then
    ...
    morph_parallel.py --output ${defaultdir}/datacards \
        ...
        --parallel 10 2>&1 | tee -a ${defaultdir}/logs/morph_log.txt
    ...
    --floatOtherPOIs 1 \
    --setParameters r_ggH=1,r_qqH=1 --setParameterRanges r_ggH=-5,5:r_qqH=-16,16:CMS_htt_ttbarShape=-10.0,10.0 \
