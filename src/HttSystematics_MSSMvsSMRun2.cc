...
void AddMSSMvsSMRun2Systematics(CombineHarvester &cb, bool jetfakes, bool embedding, bool regional_jec, bool ggh_wg1, bool qqh_wg1, int era, bool mva, bool sm, std::string smlike) {
  ...
  std::vector<int> nobtag_categories = {1, 3, 4, 5, 6, 7, 8, 9,10,
                                    ...
                                    31,32,33,34,132,232,332,432,133,233,333,433,134,234,334,434,
                                    301}; // SM and MSSM no-btag categories
  std::vector<int> btag_categories = {2,35,135,235,335,435,36,136,236,336,436,37,137,237,337,437,302};
  std::vector<int> btag_categories_forlnN = {35,135,235,335,435,36,136,236,336,436,37,137,237,337,437,302};

  std::vector<int> mssm_categories = {300,301,302,2,32,33,34,35,135,235,335,435,36,136,236,336,436,37,137,237,337,437,132,232,332,432,133,233,333,433,134,234,334,434}; // Useful in we need to use different treatment of some uncertainties for

  std::vector<int> mssm_nobtag_categories = {301,32,33,34,132,232,332,432,133,233,333,433,134,234,334,434};
  ...
  // Specific VLQ signal uncertainties
   ...
   cb.cp()
        .channel({"em","et", "mt", "tt"})
        .process(vlq_signals)
        .AddSyst(cb, "fsr", "shape", SystMap<>::init(1.00));

   cb.cp()
        .channel({"em","et", "mt", "tt"})
        .process(vlq_signals)
        .AddSyst(cb, "isr", "shape", SystMap<>::init(1.00));

   cb.cp()
        .channel({"em","et", "mt", "tt"})
        .process(vlq_signals)
        .AddSyst(cb, "pdf_variation", "shape", SystMap<>::init(1.00));
 ...
 if (!sm) {
  ...
  ({"em"}, {"2016"}, {35,135,235,335,435}, 1.0, 1.0)
  ({"em"}, {"2017"}, {35,135,235,335,435}, 1.0, 1.024)
  ({"em"}, {"2018"}, {35,135,235,335,435}, 1.0, 1.069)
  ({"em"}, {"2016"}, {36,136,236,336,436}, 1.0, 1.0)
  ({"em"}, {"2017"}, {36,136,236,336,436}, 1.0, 1.004)
  ({"em"}, {"2018"}, {36,136,236,336,436}, 0.962, 1.0)
  ({"em"}, {"2016"}, {37,137,237,337,437}, 1.0, 1.0)
  ({"em"}, {"2017"}, {37,137,237,337,437}, 0.987, 1.015)
  ({"em"}, {"2018"}, {37,137,237,337,437}, 0.981, 1.015)
  ({"em"}, {"2016"}, {32,132,232,332,432}, 1.0, 1.0)
  ({"em"}, {"2017"}, {32,132,232,332,432}, 1.0, 0.996)
  ({"em"}, {"2018"}, {32,132,232,332,432}, 1.0, 0.99)
  ({"em"}, {"2016"}, {33,133,233,333,433}, 1.0, 1.0)
  ({"em"}, {"2017"}, {33,133,233,333,433}, 1.0, 1.0)
  ({"em"}, {"2018"}, {33,133,233,333,433}, 1.003, 1.0)
  ({"em"}, {"2016"}, {34,134,234,334,434}, 0.998, 0.998)
  ({"em"}, {"2017"}, {34,134,234,334,434}, 1.001, 0.999)
  ({"em"}, {"2018"}, {34,134,234,334,434}, 1.001, 0.999)
  ...
  ({"em"}, {"2016"}, {35,135,235,335,435}, 1.0, 1.0)
  ({"em"}, {"2017"}, {35,135,235,335,435}, 0.993, 1.0)
  ({"em"}, {"2018"}, {35,135,235,335,435}, 0.952, 1.0)
  ({"em"}, {"2016"}, {36,136,236,336,436}, 0.99, 1.0)
  ({"em"}, {"2017"}, {36,136,236,336,436}, 0.993, 1.005)
  ({"em"}, {"2018"}, {36,136,236,336,436}, 0.985, 1.016)
  ({"em"}, {"2016"}, {37,137,237,337,437}, 0.987, 0.987)
  ({"em"}, {"2017"}, {37,137,237,337,437}, 0.983, 1.007)
  ({"em"}, {"2018"}, {37,137,237,337,437}, 0.988, 1.008)
  ({"em"}, {"2016"}, {32,132,232,332,432}, 1.0, 1.0)
  ({"em"}, {"2017"}, {32,132,232,332,432}, 1.001, 1.0)
  ({"em"}, {"2018"}, {32,132,232,332,432}, 1.006, 1.0)
  ({"em"}, {"2016"}, {33,133,233,333,433}, 0.999, 0.999)
  ({"em"}, {"2017"}, {33,133,233,333,433}, 1.0, 1.0)
  ({"em"}, {"2018"}, {33,133,233,333,433}, 1.001, 0.999)
  ({"em"}, {"2016"}, {34,134,234,334,434}, 1.001, 1.001)
  ({"em"}, {"2017"}, {34,134,234,334,434}, 1.002, 1.0)
  ({"em"}, {"2018"}, {34,134,234,334,434}, 1.0, 0.999)
  ...
  ({"et"}, {"2016"}, {35,135,235,335,435}, 0.992, 1.033)
  ({"et"}, {"2017"}, {35,135,235,335,435}, 0.966, 1.04)
  ({"et"}, {"2018"}, {35,135,235,335,435}, 0.968, 1.105)
  ({"et"}, {"2016"}, {36,136,236,336,436}, 1.0, 1.02)
  ({"et"}, {"2017"}, {36,136,236,336,436}, 0.96, 1.069)
  ({"et"}, {"2018"}, {36,136,236,336,436}, 0.983, 1.069)
  ({"et"}, {"2016"}, {32,132,232,332,432}, 1.0, 0.999)
  ({"et"}, {"2017"}, {32,132,232,332,432}, 1.003, 1.001)
  ({"et"}, {"2018"}, {32,132,232,332,432}, 1.001, 0.996)
  ({"et"}, {"2016"}, {33,133,233,333,433}, 1.0, 0.999)
  ({"et"}, {"2017"}, {33,133,233,333,433}, 1.006, 1.001)
  ({"et"}, {"2018"}, {33,133,233,333,433}, 1.001, 0.996)
  ({"mt"}, {"2016"}, {35,135,235,335,435}, 0.984, 1.008)
  ({"mt"}, {"2017"}, {35,135,235,335,435}, 0.97, 1.033)
  ({"mt"}, {"2018"}, {35,135,235,335,435}, 0.978, 1.04)
  ({"mt"}, {"2016"}, {36,136,236,336,436}, 0.978, 1.037)
  ({"mt"}, {"2017"}, {36,136,236,336,436}, 0.972, 1.062)
  ({"mt"}, {"2018"}, {36,136,236,336,436}, 0.99, 1.022)
  ({"mt"}, {"2016"}, {32,132,232,332,432}, 1.0, 1.0)
  ({"mt"}, {"2017"}, {32,132,232,332,432}, 1.003, 1.001)
  ({"mt"}, {"2018"}, {32,132,232,332,432}, 1.001, 0.999)
  ({"mt"}, {"2016"}, {33,133,233,333,433}, 1.001, 0.999)
  ({"mt"}, {"2017"}, {33,133,233,333,433}, 1.004, 0.999)
  ({"mt"}, {"2018"}, {33,133,233,333,433}, 1.001, 0.999)
  ({"mt"}, {"2016"}, {301}, 1.000, 0.999)
  ({"mt"}, {"2016"}, {302}, 0.986, 1.020)
  ({"mt"}, {"2017"}, {301}, 1.001, 0.998)
  ({"mt"}, {"2017"}, {302}, 0.983, 1.045)
  ({"mt"}, {"2018"}, {301}, 1.001, 0.998)
  ({"mt"}, {"2018"}, {302}, 0.983, 1.056)
  ({"tt"}, {"2016"}, {35,135,235,335,435}, 0.971, 1.017)
  ({"tt"}, {"2017"}, {35,135,235,335,435}, 1.004, 1.062)
  ({"tt"}, {"2018"}, {35,135,235,335,435}, 0.948, 1.038)
  ({"tt"}, {"2016"}, {32,132,232,332,432}, 1.002, 0.999)
  ({"tt"}, {"2017"}, {32,132,232,332,432}, 1.003, 1.0)
  ({"tt"}, {"2018"}, {32,132,232,332,432}, 1.004, 0.997)
  );

  cb.cp().process({"TTL"}).AddSyst(cb, "CMS_htt_eff_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
  ({"em"}, {"2016"}, {35,135,235,335,435}, 0.99, 1.009)
  ({"em"}, {"2017"}, {35,135,235,335,435}, 0.982, 1.016)
  ({"em"}, {"2018"}, {35,135,235,335,435}, 0.99, 1.009)
  ({"em"}, {"2016"}, {36,136,236,336,436}, 0.99, 1.009)
  ({"em"}, {"2017"}, {36,136,236,336,436}, 0.982, 1.016)
  ({"em"}, {"2018"}, {36,136,236,336,436}, 0.99, 1.009)
  ({"em"}, {"2016"}, {37,137,237,337,437}, 0.99, 1.009)
  ({"em"}, {"2017"}, {37,137,237,337,437}, 0.981, 1.017)
  ({"em"}, {"2018"}, {37,137,237,337,437}, 0.99, 1.009)
  ({"em"}, {"2016"}, {32,132,232,332,432}, 1.057, 0.944)
  ({"em"}, {"2017"}, {32,132,232,332,432}, 1.11, 0.89)
  ({"em"}, {"2018"}, {32,132,232,332,432}, 1.073, 0.926)
  ({"em"}, {"2016"}, {33,133,233,333,433}, 1.053, 0.947)
  ({"em"}, {"2017"}, {33,133,233,333,433}, 1.11, 0.895)
  ({"em"}, {"2018"}, {33,133,233,333,433}, 1.072, 0.926)
  ({"em"}, {"2016"}, {34,134,234,334,434}, 1.052, 0.947)
  ({"em"}, {"2017"}, {34,134,234,334,434}, 1.108, 0.892)
  ({"em"}, {"2018"}, {34,134,234,334,434}, 1.068, 0.931)
  ...
  // ({"em"}, {"2017"}, {2}, 1.0, 1.0)
  // ({"em"}, {"2018"}, {2}, 1.0, 1.0)
  ({"et"}, {"2016"}, {35,135,235,335,435}, 0.964, 0.984)
  ({"et"}, {"2017"}, {35,135,235,335,435}, 0.983, 1.018)
  ({"et"}, {"2018"}, {35,135,235,335,435}, 0.991, 1.009)
  ({"et"}, {"2016"}, {36,136,236,336,436}, 0.961, 0.98)
  ({"et"}, {"2017"}, {36,136,236,336,436}, 0.98, 1.018)
  ({"et"}, {"2018"}, {36,136,236,336,436}, 0.991, 1.009)
  ({"et"}, {"2016"}, {32,132,232,332,432}, 1.027, 0.917)
  ({"et"}, {"2017"}, {32,132,232,332,432}, 1.116, 0.882)
  ({"et"}, {"2018"}, {32,132,232,332,432}, 1.073, 0.929)
  ({"et"}, {"2016"}, {33,133,233,333,433}, 1.024, 0.925)
  ({"et"}, {"2017"}, {33,133,233,333,433}, 1.13, 0.883)
  ({"et"}, {"2018"}, {33,133,233,333,433}, 1.075, 0.926)
  ({"mt"}, {"2016"}, {35,135,235,335,435}, 0.965, 0.985)
  ({"mt"}, {"2017"}, {35,135,235,335,435}, 0.98, 1.018)
  ({"mt"}, {"2018"}, {35,135,235,335,435}, 0.99, 1.009)
  ({"mt"}, {"2016"}, {36,136,236,336,436}, 0.962, 0.983)
  ({"mt"}, {"2017"}, {36,136,236,336,436}, 0.982, 1.019)
  ({"mt"}, {"2018"}, {36,136,236,336,436}, 0.99, 1.009)
  ({"mt"}, {"2016"}, {32,132,232,332,432}, 1.032, 0.923)
  ({"mt"}, {"2017"}, {32,132,232,332,432}, 1.138, 0.876)
  ({"mt"}, {"2018"}, {32,132,232,332,432}, 1.081, 0.928)
  ({"mt"}, {"2016"}, {33,133,233,333,433}, 1.034, 0.925)
  ({"mt"}, {"2017"}, {33,133,233,333,433}, 1.117, 0.874)
  ({"mt"}, {"2018"}, {33,133,233,333,433}, 1.08, 0.927)
  ({"mt"}, {"2016"}, {301}, 1.059, 0.945)
  ({"mt"}, {"2016"}, {302}, 0.990, 1.010)
  ({"mt"}, {"2017"}, {301}, 1.117, 0.886)
  ({"mt"}, {"2017"}, {302}, 0.982, 1.017)
  ({"mt"}, {"2018"}, {301}, 1.076, 0.927)
  ({"mt"}, {"2018"}, {302}, 0.991, 1.009)
  ({"tt"}, {"2016"}, {35,135,235,335,435}, 0.968, 0.982)
  ({"tt"}, {"2017"}, {35,135,235,335,435}, 0.991, 1.015)
  ({"tt"}, {"2018"}, {35,135,235,335,435}, 0.989, 1.009)
  ({"tt"}, {"2016"}, {32,132,232,332,432}, 1.02, 0.95)
  ({"tt"}, {"2017"}, {32,132,232,332,432}, 1.061, 0.892)
  ({"tt"}, {"2018"}, {32,132,232,332,432}, 1.084, 0.936)
  );

  cb.cp().process({"VVL"}).AddSyst(cb, "CMS_htt_eff_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
  ({"em"}, {"2016"}, {35,135,235,335,435}, 0.986, 1.01)
  ({"em"}, {"2017"}, {35,135,235,335,435}, 0.976, 1.019)
  ({"em"}, {"2018"}, {35,135,235,335,435}, 0.987, 1.013)
  ({"em"}, {"2016"}, {36,136,236,336,436}, 0.984, 1.012)
  ({"em"}, {"2017"}, {36,136,236,336,436}, 0.975, 1.024)
  ({"em"}, {"2018"}, {36,136,236,336,436}, 0.986, 1.014)
  ({"em"}, {"2016"}, {37,137,237,337,437}, 0.986, 1.013)
  ({"em"}, {"2017"}, {37,137,237,337,437}, 0.974, 1.023)
  ({"em"}, {"2018"}, {37,137,237,337,437}, 0.986, 1.014)
  ({"em"}, {"2016"}, {32,132,232,332,432}, 1.01, 0.991)
  ({"em"}, {"2017"}, {32,132,232,332,432}, 1.019, 0.981)
  ({"em"}, {"2018"}, {32,132,232,332,432}, 1.011, 0.986)
  ({"em"}, {"2016"}, {33,133,233,333,433}, 1.006, 0.994)
  ({"em"}, {"2017"}, {33,133,233,333,433}, 1.011, 0.987)
  ({"em"}, {"2018"}, {33,133,233,333,433}, 1.007, 0.992)
  ({"em"}, {"2016"}, {34,134,234,334,434}, 1.004, 0.995)
  ({"em"}, {"2017"}, {34,134,234,334,434}, 1.009, 0.991)
  ({"em"}, {"2018"}, {34,134,234,334,434}, 1.005, 0.994)
  ...
  // ({"em"}, {"2017"}, {2}, 1.0, 1.0)
  // ({"em"}, {"2018"}, {2}, 1.0, 1.0)
  ({"et"}, {"2016"}, {35,135,235,335,435}, 0.986, 1.015)
  ({"et"}, {"2017"}, {35,135,235,335,435}, 0.972, 1.033)
  ({"et"}, {"2018"}, {35,135,235,335,435}, 0.985, 1.016)
  ({"et"}, {"2016"}, {36,136,236,336,436}, 0.982, 1.018)
  ({"et"}, {"2017"}, {36,136,236,336,436}, 0.975, 1.027)
  ({"et"}, {"2018"}, {36,136,236,336,436}, 0.985, 1.013)
  ({"et"}, {"2016"}, {32,132,232,332,432}, 1.005, 0.994)
  ({"et"}, {"2017"}, {32,132,232,332,432}, 1.019, 0.978)
  ({"et"}, {"2018"}, {32,132,232,332,432}, 1.01, 0.99)
  ({"et"}, {"2016"}, {33,133,233,333,433}, 1.006, 0.994)
  ({"et"}, {"2017"}, {33,133,233,333,433}, 1.015, 0.984)
  ({"et"}, {"2018"}, {33,133,233,333,433}, 1.009, 0.993)
  ({"mt"}, {"2016"}, {35,135,235,335,435}, 0.984, 1.016)
  ({"mt"}, {"2017"}, {35,135,235,335,435}, 0.974, 1.024)
  ({"mt"}, {"2018"}, {35,135,235,335,435}, 0.987, 1.017)
  ({"mt"}, {"2016"}, {36,136,236,336,436}, 0.984, 1.013)
  ({"mt"}, {"2017"}, {36,136,236,336,436}, 0.969, 1.028)
  ({"mt"}, {"2018"}, {36,136,236,336,436}, 0.983, 1.016)
  ({"mt"}, {"2016"}, {32,132,232,332,432}, 1.005, 0.995)
  ({"mt"}, {"2017"}, {32,132,232,332,432}, 1.017, 0.984)
  ({"mt"}, {"2018"}, {32,132,232,332,432}, 1.008, 0.989)
  ({"mt"}, {"2016"}, {33,133,233,333,433}, 1.005, 0.996)
  ({"mt"}, {"2017"}, {33,133,233,333,433}, 1.019, 0.983)
  ({"mt"}, {"2018"}, {33,133,233,333,433}, 1.01, 0.991)
  ({"mt"}, {"2016"}, {301}, 1.008, 0.993)
  ({"mt"}, {"2016"}, {302}, 0.985, 1.015)
  ({"mt"}, {"2017"}, {301}, 1.016, 0.985)
  ({"mt"}, {"2017"}, {302}, 0.971, 1.026)
  ({"mt"}, {"2018"}, {301}, 1.008, 0.991)
  ({"mt"}, {"2018"}, {302}, 0.986, 1.015)
  ({"tt"}, {"2016"}, {35,135,235,335,435}, 0.976, 1.006)
  ({"tt"}, {"2017"}, {35,135,235,335,435}, 0.987, 1.033)
  ({"tt"}, {"2018"}, {35,135,235,335,435}, 0.984, 1.0)
  ({"tt"}, {"2016"}, {32,132,232,332,432}, 1.01, 0.998)
  ({"tt"}, {"2017"}, {32,132,232,332,432}, 1.01, 0.975)
  ({"tt"}, {"2018"}, {32,132,232,332,432}, 1.011, 1.0)
  );
 ...
 cb.cp().process(signals_ggH).process({"ggX"}, false).AddSyst(cb, "CMS_htt_eff_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
  ({"em"}, {"2016"}, {35,135,235,335,435}, 0.995, 1.01)
  ({"em"}, {"2017"}, {35,135,235,335,435}, 0.993, 1.019)
  ({"em"}, {"2018"}, {35,135,235,335,435}, 0.993, 1.005)
  ({"em"}, {"2016"}, {36,136,236,336,436}, 0.993, 1.012)
  ({"em"}, {"2017"}, {36,136,236,336,436}, 0.986, 1.009)
  ({"em"}, {"2018"}, {36,136,236,336,436}, 0.996, 1.011)
  ({"em"}, {"2016"}, {37,137,237,337,437}, 0.991, 1.009)
  ({"em"}, {"2017"}, {37,137,237,337,437}, 0.986, 1.012)
  ({"em"}, {"2018"}, {37,137,237,337,437}, 0.996, 1.007)
  ({"em"}, {"2016"}, {32,132,232,332,432}, 0.999, 0.998)
  ({"em"}, {"2017"}, {32,132,232,332,432}, 1.0, 0.998)
  ({"em"}, {"2018"}, {32,132,232,332,432}, 1.0, 0.999)
  ({"em"}, {"2016"}, {33,133,233,333,433}, 1.0, 1.0)
  ({"em"}, {"2017"}, {33,133,233,333,433}, 1.0, 0.999)
  ({"em"}, {"2018"}, {33,133,233,333,433}, 1.0, 0.999)
  ({"em"}, {"2016"}, {34,134,234,334,434}, 1.0, 1.0)
  ({"em"}, {"2017"}, {34,134,234,334,434}, 1.001, 1.0)
  ({"em"}, {"2018"}, {34,134,234,334,434}, 1.001, 1.0)
  ...
  // ({"em"}, {"2017"}, {2}, 1.0, 1.0)
  // ({"em"}, {"2018"}, {2}, 1.0, 1.0)
  ({"et"}, {"2016"}, {35,135,235,335,435}, 0.977, 1.024)
  ({"et"}, {"2017"}, {35,135,235,335,435}, 0.967, 1.04)
  ({"et"}, {"2018"}, {35,135,235,335,435}, 0.982, 1.026)
  ({"et"}, {"2016"}, {36,136,236,336,436}, 0.977, 1.03)
  ({"et"}, {"2017"}, {36,136,236,336,436}, 0.97, 1.029)
  ({"et"}, {"2018"}, {36,136,236,336,436}, 0.979, 1.025)
  ({"et"}, {"2016"}, {32,132,232,332,432}, 1.001, 0.999)
  ({"et"}, {"2017"}, {32,132,232,332,432}, 1.001, 0.998)
  ({"et"}, {"2018"}, {32,132,232,332,432}, 1.001, 0.999)
  ({"et"}, {"2016"}, {33,133,233,333,433}, 1.001, 0.999)
  ({"et"}, {"2017"}, {33,133,233,333,433}, 1.002, 0.998)
  ({"et"}, {"2018"}, {33,133,233,333,433}, 1.001, 0.998)
  ({"mt"}, {"2016"}, {35,135,235,335,435}, 0.977, 1.023)
  ({"mt"}, {"2017"}, {35,135,235,335,435}, 0.967, 1.036)
  ({"mt"}, {"2018"}, {35,135,235,335,435}, 0.981, 1.022)
  ({"mt"}, {"2016"}, {36,136,236,336,436}, 0.977, 1.025)
  ({"mt"}, {"2017"}, {36,136,236,336,436}, 0.97, 1.035)
  ({"mt"}, {"2018"}, {36,136,236,336,436}, 0.982, 1.021)
  ({"mt"}, {"2016"}, {32,132,232,332,432}, 1.001, 0.999)
  ({"mt"}, {"2017"}, {32,132,232,332,432}, 1.001, 0.998)
  ({"mt"}, {"2018"}, {32,132,232,332,432}, 1.001, 0.999)
  ({"mt"}, {"2016"}, {33,133,233,333,433}, 1.001, 0.999)
  ({"mt"}, {"2017"}, {33,133,233,333,433}, 1.002, 0.998)
  ({"mt"}, {"2018"}, {33,133,233,333,433}, 1.001, 0.999)
  ({"mt"}, {"2016"}, {301}, 1.001, 0.999)
  ({"mt"}, {"2016"}, {302}, 0.977, 1.023)
  ({"mt"}, {"2017"}, {301}, 1.002, 0.998)
  ({"mt"}, {"2017"}, {302}, 0.967, 1.035)
  ({"mt"}, {"2018"}, {301}, 1.001, 0.999)
  ({"mt"}, {"2018"}, {302}, 0.981, 1.022)
  ({"tt"}, {"2016"}, {35,135,235,335,435}, 0.978, 1.025)
  ({"tt"}, {"2017"}, {35,135,235,335,435}, 0.965, 1.039)
  ({"tt"}, {"2018"}, {35,135,235,335,435}, 0.981, 1.024)
  ({"tt"}, {"2016"}, {32,132,232,332,432}, 1.001, 0.999)
  ({"tt"}, {"2017"}, {32,132,232,332,432}, 1.002, 0.998)
  ({"tt"}, {"2018"}, {32,132,232,332,432}, 1.001, 0.998)
  );

  cb.cp().process({"qqX"}).AddSyst(cb, "CMS_htt_eff_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
  ({"em"}, {"2016"}, {35,135,235,335,435}, 0.996, 1.0)
  ({"em"}, {"2017"}, {35,135,235,335,435}, 0.988, 1.01)
  ({"em"}, {"2018"}, {35,135,235,335,435}, 0.993, 1.002)
  ({"em"}, {"2016"}, {36,136,236,336,436}, 0.997, 1.007)
  ({"em"}, {"2017"}, {36,136,236,336,436}, 0.994, 1.015)
  ({"em"}, {"2018"}, {36,136,236,336,436}, 0.994, 1.002)
  ({"em"}, {"2016"}, {37,137,237,337,437}, 0.979, 1.014)
  ({"em"}, {"2017"}, {37,137,237,337,437}, 0.986, 1.017)
  ({"em"}, {"2018"}, {37,137,237,337,437}, 1.002, 1.016)
  ({"em"}, {"2016"}, {32,132,232,332,432}, 1.0, 1.0)
  ({"em"}, {"2017"}, {32,132,232,332,432}, 1.0, 0.998)
  ({"em"}, {"2018"}, {32,132,232,332,432}, 1.0, 0.999)
  ({"em"}, {"2016"}, {33,133,233,333,433}, 0.999, 0.999)
  ({"em"}, {"2017"}, {33,133,233,333,433}, 1.0, 0.999)
  ({"em"}, {"2018"}, {33,133,233,333,433}, 1.001, 1.0)
  ({"em"}, {"2016"}, {34,134,234,334,434}, 1.003, 1.001)
  ({"em"}, {"2017"}, {34,134,234,334,434}, 1.002, 1.0)
  ({"em"}, {"2018"}, {34,134,234,334,434}, 1.0, 0.999)
  ({"em"}, {"2016"}, {2}, 0.988, 1.0)
  ...
  // ({"em"}, {"2017"}, {2}, 1.0, 1.0)
  // ({"em"}, {"2018"}, {2}, 1.0, 1.0)
  ({"et"}, {"2016"}, {35,135,235,335,435}, 0.974, 1.026)
  ({"et"}, {"2017"}, {35,135,235,335,435}, 0.953, 1.045)
  ({"et"}, {"2018"}, {35,135,235,335,435}, 0.977, 1.025)
  ({"et"}, {"2016"}, {36,136,236,336,436}, 0.985, 1.021)
  ({"et"}, {"2017"}, {36,136,236,336,436}, 0.958, 1.038)
  ({"et"}, {"2018"}, {36,136,236,336,436}, 0.975, 1.021)
  ({"et"}, {"2016"}, {32,132,232,332,432}, 1.002, 0.998)
  ({"et"}, {"2017"}, {32,132,232,332,432}, 1.005, 0.995)
  ({"et"}, {"2018"}, {32,132,232,332,432}, 1.003, 0.997)
  ({"et"}, {"2016"}, {33,133,233,333,433}, 1.001, 0.998)
  ({"et"}, {"2017"}, {33,133,233,333,433}, 1.005, 0.995)
  ({"et"}, {"2018"}, {33,133,233,333,433}, 1.003, 0.997)
  ({"mt"}, {"2016"}, {35,135,235,335,435}, 0.974, 1.026)
  ({"mt"}, {"2017"}, {35,135,235,335,435}, 0.954, 1.044)
  ({"mt"}, {"2018"}, {35,135,235,335,435}, 0.973, 1.028)
  ({"mt"}, {"2016"}, {36,136,236,336,436}, 0.982, 1.022)
  ({"mt"}, {"2017"}, {36,136,236,336,436}, 0.957, 1.033)
  ({"mt"}, {"2018"}, {36,136,236,336,436}, 0.979, 1.026)
  ({"mt"}, {"2016"}, {32,132,232,332,432}, 1.002, 0.998)
  ({"mt"}, {"2017"}, {32,132,232,332,432}, 1.005, 0.995)
  ({"mt"}, {"2018"}, {32,132,232,332,432}, 1.003, 0.997)
  ({"mt"}, {"2016"}, {33,133,233,333,433}, 1.002, 0.998)
  ({"mt"}, {"2017"}, {33,133,233,333,433}, 1.005, 0.996)
  ({"mt"}, {"2018"}, {33,133,233,333,433}, 1.003, 0.997)
  ({"tt"}, {"2016"}, {35,135,235,335,435}, 0.977, 1.025)
  ({"tt"}, {"2017"}, {35,135,235,335,435}, 0.956, 1.042)
  ({"tt"}, {"2018"}, {35,135,235,335,435}, 0.976, 1.026)
  ({"tt"}, {"2016"}, {32,132,232,332,432}, 1.002, 0.998)
  ({"tt"}, {"2017"}, {32,132,232,332,432}, 1.005, 0.995)
  ({"tt"}, {"2018"}, {32,132,232,332,432}, 1.003, 0.997)
  );

  cb.cp().process(signals_qqH).AddSyst(cb, "CMS_htt_eff_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
  ({"em"}, {"2016"}, {35,135,235,335,435}, 0.996, 1.0)
  ({"em"}, {"2017"}, {35,135,235,335,435}, 0.988, 1.01)
  ({"em"}, {"2018"}, {35,135,235,335,435}, 0.993, 1.002)
  ({"em"}, {"2016"}, {36,136,236,336,436}, 0.997, 1.007)
  ...
  ({"mt"}, {"2017"}, {33,133,233,333,433}, 1.005, 0.996)
  ({"mt"}, {"2018"}, {33,133,233,333,433}, 1.003, 0.997)
  ({"mt"}, {"2016"}, {301}, 1.002, 0.998)
  ({"mt"}, {"2016"}, {302}, 0.976, 1.023)
  ({"mt"}, {"2017"}, {301}, 1.005, 0.996)
  ({"mt"}, {"2017"}, {302}, 0.956, 1.039)
  ({"mt"}, {"2018"}, {301}, 1.003, 0.997)
  ({"mt"}, {"2018"}, {302}, 0.975, 1.027)
  ({"tt"}, {"2016"}, {35,135,235,335,435}, 0.977, 1.025)
  ({"tt"}, {"2017"}, {35,135,235,335,435}, 0.956, 1.042)
  ({"tt"}, {"2018"}, {35,135,235,335,435}, 0.976, 1.026)
  ({"tt"}, {"2016"}, {32,132,232,332,432}, 1.002, 0.998)
  ...
  ({"em"}, {"2016"}, {35,135,235,335,435}, 1.0, 1.076)
  ({"em"}, {"2017"}, {35,135,235,335,435}, 1.0, 1.039)
  ({"em"}, {"2018"}, {35,135,235,335,435}, 0.945, 1.189)
  ({"em"}, {"2016"}, {36,136,236,336,436}, 1.0, 1.125)
  ({"em"}, {"2017"}, {36,136,236,336,436}, 0.956, 1.057)
  ({"em"}, {"2018"}, {36,136,236,336,436}, 0.86, 1.055)
  ({"em"}, {"2016"}, {37,137,237,337,437}, 0.753, 1.065)
  ({"em"}, {"2017"}, {37,137,237,337,437}, 0.929, 1.054)
  ({"em"}, {"2018"}, {37,137,237,337,437}, 0.932, 1.03)
  ({"em"}, {"2016"}, {32,132,232,332,432}, 1.0, 0.991)
  ({"em"}, {"2017"}, {32,132,232,332,432}, 1.0, 0.994)
  ({"em"}, {"2018"}, {32,132,232,332,432}, 1.008, 0.972)
  ({"em"}, {"2016"}, {33,133,233,333,433}, 1.0, 0.992)
  ({"em"}, {"2017"}, {33,133,233,333,433}, 1.004, 0.995)
  ({"em"}, {"2018"}, {33,133,233,333,433}, 1.01, 0.996)
  ({"em"}, {"2016"}, {34,134,234,334,434}, 1.013, 0.994)
  ({"em"}, {"2017"}, {34,134,234,334,434}, 1.004, 0.997)
  ({"em"}, {"2018"}, {34,134,234,334,434}, 1.004, 0.998)
  ...
  ({"em"}, {"2016"}, {35,135,235,335,435}, 0.855, 1.0)
  ({"em"}, {"2017"}, {35,135,235,335,435}, 1.0, 1.023)
  ({"em"}, {"2018"}, {35,135,235,335,435}, 0.983, 1.139)
  ({"em"}, {"2016"}, {36,136,236,336,436}, 0.949, 1.019)
  ({"em"}, {"2017"}, {36,136,236,336,436}, 0.965, 1.135)
  ({"em"}, {"2018"}, {36,136,236,336,436}, 0.915, 1.086)
  ({"em"}, {"2016"}, {37,137,237,337,437}, 0.879, 1.025)
  ({"em"}, {"2017"}, {37,137,237,337,437}, 0.971, 1.046)
  ({"em"}, {"2018"}, {37,137,237,337,437}, 0.935, 1.064)
  ({"em"}, {"2016"}, {32,132,232,332,432}, 1.014, 1.0)
  ({"em"}, {"2017"}, {32,132,232,332,432}, 1.0, 0.997)
  ({"em"}, {"2018"}, {32,132,232,332,432}, 1.002, 0.983)
  ({"em"}, {"2016"}, {33,133,233,333,433}, 1.001, 0.998)
  ({"em"}, {"2017"}, {33,133,233,333,433}, 1.001, 0.995)
  ({"em"}, {"2018"}, {33,133,233,333,433}, 1.004, 0.996)
  ({"em"}, {"2016"}, {34,134,234,334,434}, 1.005, 1.0)
  ({"em"}, {"2017"}, {34,134,234,334,434}, 1.003, 0.998)
  ({"em"}, {"2018"}, {34,134,234,334,434}, 1.005, 0.994)
  ...
  // ({"em"}, {"2017"}, {2}, 0.999, 0.999)
  // ({"em"}, {"2018"}, {2}, 1.001, 1.001)
  ({"et"}, {"2016"}, {35,135,235,335,435}, 0.944, 1.074)
  ({"et"}, {"2017"}, {35,135,235,335,435}, 0.938, 1.093)
  ({"et"}, {"2018"}, {35,135,235,335,435}, 0.874, 1.103)
  ({"et"}, {"2016"}, {36,136,236,336,436}, 0.959, 1.055)
  ({"et"}, {"2017"}, {36,136,236,336,436}, 0.97, 1.063)
  ({"et"}, {"2018"}, {36,136,236,336,436}, 0.847, 1.05)
  ({"et"}, {"2016"}, {32,132,232,332,432}, 1.001, 0.998)
  ({"et"}, {"2017"}, {32,132,232,332,432}, 1.004, 0.999)
  ({"et"}, {"2018"}, {32,132,232,332,432}, 1.005, 0.996)
  ({"et"}, {"2016"}, {33,133,233,333,433}, 1.001, 0.998)
  ({"et"}, {"2017"}, {33,133,233,333,433}, 1.005, 1.001)
  ({"et"}, {"2018"}, {33,133,233,333,433}, 1.01, 0.997)
  ({"mt"}, {"2016"}, {35,135,235,335,435}, 0.926, 1.086)
  ({"mt"}, {"2017"}, {35,135,235,335,435}, 0.96, 1.098)
  ({"mt"}, {"2018"}, {35,135,235,335,435}, 0.942, 1.191)
  ({"mt"}, {"2016"}, {36,136,236,336,436}, 0.891, 1.114)
  ({"mt"}, {"2017"}, {36,136,236,336,436}, 0.931, 1.023)
  ({"mt"}, {"2018"}, {36,136,236,336,436}, 0.946, 1.093)
  ({"mt"}, {"2016"}, {32,132,232,332,432}, 1.002, 0.998)
  ({"mt"}, {"2017"}, {32,132,232,332,432}, 1.004, 0.998)
  ({"mt"}, {"2018"}, {32,132,232,332,432}, 1.002, 0.993)
  ({"mt"}, {"2016"}, {33,133,233,333,433}, 1.003, 0.996)
  ({"mt"}, {"2017"}, {33,133,233,333,433}, 1.006, 1.001)
  ({"mt"}, {"2018"}, {33,133,233,333,433}, 1.004, 0.994)
  ({"mt"}, {"2016"}, {301}, 1.001, 0.998)
  ({"mt"}, {"2016"}, {302}, 0.956, 1.062)
  ({"mt"}, {"2017"}, {301}, 1.006, 0.997)
  ({"mt"}, {"2017"}, {302}, 0.881, 1.074)
  ({"mt"}, {"2018"}, {301}, 1.003, 0.996)
  ({"mt"}, {"2018"}, {302}, 0.923, 1.109)
  ({"tt"}, {"2016"}, {35,135,235,335,435}, 0.949, 1.018)
  ({"tt"}, {"2017"}, {35,135,235,335,435}, 0.924, 1.098)
  ({"tt"}, {"2018"}, {35,135,235,335,435}, 0.867, 1.054)
  ({"tt"}, {"2016"}, {32,132,232,332,432}, 1.003, 0.999)
  ({"tt"}, {"2017"}, {32,132,232,332,432}, 1.007, 0.999)
  ({"tt"}, {"2018"}, {32,132,232,332,432}, 1.01, 0.996)
  );

  cb.cp().process({"TTL"}).AddSyst(cb, "CMS_htt_mistag_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
  ({"em"}, {"2016"}, {35,135,235,335,435}, 0.999, 1.001)
  ({"em"}, {"2017"}, {35,135,235,335,435}, 0.998, 1.001)
  ({"em"}, {"2018"}, {35,135,235,335,435}, 0.998, 1.001)
  ({"em"}, {"2016"}, {36,136,236,336,436}, 0.999, 1.001)
  ({"em"}, {"2017"}, {36,136,236,336,436}, 0.998, 1.001)
  ({"em"}, {"2018"}, {36,136,236,336,436}, 0.998, 1.001)
  ({"em"}, {"2016"}, {37,137,237,337,437}, 0.999, 1.0)
  ({"em"}, {"2017"}, {37,137,237,337,437}, 0.998, 1.001)
  ({"em"}, {"2018"}, {37,137,237,337,437}, 0.998, 1.001)
  ({"em"}, {"2016"}, {32,132,232,332,432}, 1.005, 0.993)
  ({"em"}, {"2017"}, {32,132,232,332,432}, 1.008, 0.991)
  ({"em"}, {"2018"}, {32,132,232,332,432}, 1.013, 0.988)
  ({"em"}, {"2016"}, {33,133,233,333,433}, 1.004, 0.995)
  ({"em"}, {"2017"}, {33,133,233,333,433}, 1.006, 0.99)
  ({"em"}, {"2018"}, {33,133,233,333,433}, 1.01, 0.989)
  ({"em"}, {"2016"}, {34,134,234,334,434}, 1.004, 0.995)
  ({"em"}, {"2017"}, {34,134,234,334,434}, 1.007, 0.992)
  ({"em"}, {"2018"}, {34,134,234,334,434}, 1.01, 0.989)
  ...
  //({"em"}, {"2017"}, {2}, 1.0, 1.0)
  //({"em"}, {"2018"}, {2}, 1.0, 1.0)
  ({"et"}, {"2016"}, {35,135,235,335,435}, 0.973, 0.975)
  ({"et"}, {"2017"}, {35,135,235,335,435}, 0.999, 1.001)
  ({"et"}, {"2018"}, {35,135,235,335,435}, 0.999, 1.001)
  ({"et"}, {"2016"}, {36,136,236,336,436}, 0.97, 0.971)
  ({"et"}, {"2017"}, {36,136,236,336,436}, 0.999, 1.0)
  ({"et"}, {"2018"}, {36,136,236,336,436}, 0.999, 1.001)
  ({"et"}, {"2016"}, {32,132,232,332,432}, 0.976, 0.968)
  ({"et"}, {"2017"}, {32,132,232,332,432}, 1.006, 0.99)
  ({"et"}, {"2018"}, {32,132,232,332,432}, 1.009, 0.992)
  ({"et"}, {"2016"}, {33,133,233,333,433}, 0.977, 0.971)
  ({"et"}, {"2017"}, {33,133,233,333,433}, 1.007, 0.997)
  ({"et"}, {"2018"}, {33,133,233,333,433}, 1.009, 0.991)
  ({"mt"}, {"2016"}, {35,135,235,335,435}, 0.974, 0.975)
  ({"mt"}, {"2017"}, {35,135,235,335,435}, 0.999, 1.001)
  ({"mt"}, {"2018"}, {35,135,235,335,435}, 0.999, 1.001)
  ({"mt"}, {"2016"}, {36,136,236,336,436}, 0.973, 0.974)
  ({"mt"}, {"2017"}, {36,136,236,336,436}, 0.999, 1.001)
  ({"mt"}, {"2018"}, {36,136,236,336,436}, 0.999, 1.001)
  ({"mt"}, {"2016"}, {32,132,232,332,432}, 0.981, 0.973)
  ({"mt"}, {"2017"}, {32,132,232,332,432}, 1.005, 0.995)
  ({"mt"}, {"2018"}, {32,132,232,332,432}, 1.01, 0.99)
  ({"mt"}, {"2016"}, {33,133,233,333,433}, 0.978, 0.97)
  ({"mt"}, {"2017"}, {33,133,233,333,433}, 1.006, 0.995)
  ({"mt"}, {"2018"}, {33,133,233,333,433}, 1.01, 0.991)
  ({"mt"}, {"2016"}, {301}, 1.003, 0.996)
  ({"mt"}, {"2016"}, {302}, 0.999, 1.001)
  ({"mt"}, {"2017"}, {301}, 1.006, 0.996)
  ({"mt"}, {"2017"}, {302}, 0.999, 1.001)
  ({"mt"}, {"2018"}, {301}, 1.009, 0.991)
  ({"mt"}, {"2018"}, {302}, 0.999, 1.001)
  ({"tt"}, {"2016"}, {35,135,235,335,435}, 0.976, 0.976)
  ({"tt"}, {"2017"}, {35,135,235,335,435}, 1.0, 1.0)
  ({"tt"}, {"2018"}, {35,135,235,335,435}, 0.999, 1.001)
  ({"tt"}, {"2016"}, {32,132,232,332,432}, 0.982, 0.982)
  ({"tt"}, {"2017"}, {32,132,232,332,432}, 1.0, 1.0)
  ({"tt"}, {"2018"}, {32,132,232,332,432}, 1.011, 0.99)
  );

  cb.cp().process({"VVL"}).AddSyst(cb, "CMS_htt_mistag_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
  ({"em"}, {"2016"}, {35,135,235,335,435}, 0.993, 1.008)
  ({"em"}, {"2017"}, {35,135,235,335,435}, 0.99, 1.009)
  ({"em"}, {"2018"}, {35,135,235,335,435}, 0.987, 1.013)
  ({"em"}, {"2016"}, {36,136,236,336,436}, 0.992, 1.006)
  ({"em"}, {"2017"}, {36,136,236,336,436}, 0.989, 1.01)
  ({"em"}, {"2018"}, {36,136,236,336,436}, 0.986, 1.014)
  ({"em"}, {"2016"}, {37,137,237,337,437}, 0.992, 1.008)
  ({"em"}, {"2017"}, {37,137,237,337,437}, 0.989, 1.012)
  ({"em"}, {"2018"}, {37,137,237,337,437}, 0.984, 1.015)
  ({"em"}, {"2016"}, {32,132,232,332,432}, 1.005, 0.993)
  ({"em"}, {"2017"}, {32,132,232,332,432}, 1.006, 0.99)
  ({"em"}, {"2018"}, {32,132,232,332,432}, 1.011, 0.986)
  ({"em"}, {"2016"}, {33,133,233,333,433}, 1.003, 0.996)
  ({"em"}, {"2017"}, {33,133,233,333,433}, 1.004, 0.994)
  ({"em"}, {"2018"}, {33,133,233,333,433}, 1.007, 0.992)
  ({"em"}, {"2016"}, {34,134,234,334,434}, 1.002, 0.997)
  ({"em"}, {"2017"}, {34,134,234,334,434}, 1.004, 0.995)
  ({"em"}, {"2018"}, {34,134,234,334,434}, 1.006, 0.994)
  ...
  // ({"em"}, {"2017"}, {2}, 1.0, 1.0)
  // ({"em"}, {"2018"}, {2}, 1.0, 1.0)
  ({"et"}, {"2016"}, {35,135,235,335,435}, 0.99, 1.009)
  ({"et"}, {"2017"}, {35,135,235,335,435}, 0.993, 1.006)
  ({"et"}, {"2018"}, {35,135,235,335,435}, 0.991, 1.012)
  ({"et"}, {"2016"}, {36,136,236,336,436}, 0.99, 1.007)
  ({"et"}, {"2017"}, {36,136,236,336,436}, 0.994, 1.005)
  ({"et"}, {"2018"}, {36,136,236,336,436}, 0.988, 1.01)
  ({"et"}, {"2016"}, {32,132,232,332,432}, 1.004, 0.997)
  ({"et"}, {"2017"}, {32,132,232,332,432}, 1.005, 0.996)
  ({"et"}, {"2018"}, {32,132,232,332,432}, 1.006, 0.992)
  ({"et"}, {"2016"}, {33,133,233,333,433}, 1.003, 0.998)
  ({"et"}, {"2017"}, {33,133,233,333,433}, 1.004, 0.997)
  ({"et"}, {"2018"}, {33,133,233,333,433}, 1.007, 0.994)
  ({"mt"}, {"2016"}, {35,135,235,335,435}, 0.992, 1.011)
  ({"mt"}, {"2017"}, {35,135,235,335,435}, 0.993, 1.005)
  ({"mt"}, {"2018"}, {35,135,235,335,435}, 0.991, 1.011)
  ({"mt"}, {"2016"}, {36,136,236,336,436}, 0.987, 1.006)
  ({"mt"}, {"2017"}, {36,136,236,336,436}, 0.995, 1.005)
  ({"mt"}, {"2018"}, {36,136,236,336,436}, 0.99, 1.009)
  ({"mt"}, {"2016"}, {32,132,232,332,432}, 1.003, 0.996)
  ({"mt"}, {"2017"}, {32,132,232,332,432}, 1.005, 0.997)
  ({"mt"}, {"2018"}, {32,132,232,332,432}, 1.006, 0.993)
  ({"mt"}, {"2016"}, {33,133,233,333,433}, 1.004, 0.998)
  ({"mt"}, {"2017"}, {33,133,233,333,433}, 1.003, 0.997)
  ({"mt"}, {"2018"}, {33,133,233,333,433}, 1.006, 0.995)
  ({"mt"}, {"2016"}, {301}, 1.003, 0.997)
  ({"mt"}, {"2016"}, {302}, 0.994, 1.006)
  ({"mt"}, {"2017"}, {301}, 1.003, 0.996)
  ({"mt"}, {"2017"}, {302}, 0.994, 1.007)
  ({"mt"}, {"2018"}, {301}, 1.008, 0.994)
  ({"mt"}, {"2018"}, {302}, 0.987, 1.010)
  ({"tt"}, {"2016"}, {35,135,235,335,435}, 1.001, 1.01)
  ({"tt"}, {"2017"}, {35,135,235,335,435}, 1.0, 0.998)
  ({"tt"}, {"2018"}, {35,135,235,335,435}, 0.992, 1.009)
  ({"tt"}, {"2016"}, {32,132,232,332,432}, 1.0, 0.996)
  ({"tt"}, {"2017"}, {32,132,232,332,432}, 1.0, 1.001)
  ({"tt"}, {"2018"}, {32,132,232,332,432}, 1.005, 0.994)
  );
  ...
  ({"em"}, {"2016"}, {35,135,235,335,435}, 0.905, 1.092)
  ({"em"}, {"2017"}, {35,135,235,335,435}, 0.892, 1.106)
  ({"em"}, {"2018"}, {35,135,235,335,435}, 0.867, 1.113)
  ({"em"}, {"2016"}, {36,136,236,336,436}, 0.914, 1.112)
  ({"em"}, {"2017"}, {36,136,236,336,436}, 0.874, 1.114)
  ({"em"}, {"2018"}, {36,136,236,336,436}, 0.858, 1.152)
  ({"em"}, {"2016"}, {37,137,237,337,437}, 0.91, 1.113)
  ({"em"}, {"2017"}, {37,137,237,337,437}, 0.882, 1.116)
  ({"em"}, {"2018"}, {37,137,237,337,437}, 0.849, 1.128)
  ({"em"}, {"2016"}, {32,132,232,332,432}, 1.006, 0.992)
  ({"em"}, {"2017"}, {32,132,232,332,432}, 1.008, 0.991)
  ({"em"}, {"2018"}, {32,132,232,332,432}, 1.014, 0.987)
  ({"em"}, {"2016"}, {33,133,233,333,433}, 1.002, 0.997)
  ({"em"}, {"2017"}, {33,133,233,333,433}, 1.004, 0.996)
  ({"em"}, {"2018"}, {33,133,233,333,433}, 1.006, 0.993)
  ({"em"}, {"2016"}, {34,134,234,334,434}, 1.003, 0.997)
  ({"em"}, {"2017"}, {34,134,234,334,434}, 1.005, 0.996)
  ({"em"}, {"2018"}, {34,134,234,334,434}, 1.008, 0.994)
  ...
  // ({"em"}, {"2017"}, {2}, 1.0, 1.0)
  // ({"em"}, {"2018"}, {2}, 1.0, 1.0)
  ({"et"}, {"2016"}, {35,135,235,335,435}, 0.939, 1.08)
  ({"et"}, {"2017"}, {35,135,235,335,435}, 0.921, 1.074)
  ({"et"}, {"2018"}, {35,135,235,335,435}, 0.882, 1.118)
  ({"et"}, {"2016"}, {36,136,236,336,436}, 0.937, 1.062)
  ({"et"}, {"2017"}, {36,136,236,336,436}, 0.926, 1.082)
  ({"et"}, {"2018"}, {36,136,236,336,436}, 0.894, 1.123)
  ({"et"}, {"2016"}, {32,132,232,332,432}, 1.002, 0.997)
  ({"et"}, {"2017"}, {32,132,232,332,432}, 1.004, 0.997)
  ({"et"}, {"2018"}, {32,132,232,332,432}, 1.007, 0.993)
  ({"et"}, {"2016"}, {33,133,233,333,433}, 1.003, 0.997)
  ({"et"}, {"2017"}, {33,133,233,333,433}, 1.004, 0.995)
  ({"et"}, {"2018"}, {33,133,233,333,433}, 1.007, 0.992)
  ({"mt"}, {"2016"}, {35,135,235,335,435}, 0.932, 1.08)
  ({"mt"}, {"2017"}, {35,135,235,335,435}, 0.917, 1.08)
  ({"mt"}, {"2018"}, {35,135,235,335,435}, 0.878, 1.12)
  ({"mt"}, {"2016"}, {36,136,236,336,436}, 0.94, 1.074)
  ({"mt"}, {"2017"}, {36,136,236,336,436}, 0.926, 1.078)
  ({"mt"}, {"2018"}, {36,136,236,336,436}, 0.886, 1.112)
  ({"mt"}, {"2016"}, {32,132,232,332,432}, 1.002, 0.997)
  ({"mt"}, {"2017"}, {32,132,232,332,432}, 1.004, 0.997)
  ({"mt"}, {"2018"}, {32,132,232,332,432}, 1.006, 0.994)
  ({"mt"}, {"2016"}, {33,133,233,333,433}, 1.003, 0.997)
  ({"mt"}, {"2017"}, {33,133,233,333,433}, 1.004, 0.996)
  ({"mt"}, {"2018"}, {33,133,233,333,433}, 1.008, 0.992)
  ({"mt"}, {"2016"}, {301}, 1.002, 0.997)
  ({"mt"}, {"2016"}, {302}, 0.935, 1.078)
  ({"mt"}, {"2017"}, {301}, 1.004, 0.996)
  ({"mt"}, {"2017"}, {302}, 0.921, 1.079)
  ({"mt"}, {"2018"}, {301}, 1.007, 0.993)
  ({"mt"}, {"2018"}, {302}, 0.879, 1.118)
  ({"tt"}, {"2016"}, {35,135,235,335,435}, 0.945, 1.074)
  ({"tt"}, {"2017"}, {35,135,235,335,435}, 0.931, 1.073)
  ({"tt"}, {"2018"}, {35,135,235,335,435}, 0.892, 1.1)
  ({"tt"}, {"2016"}, {32,132,232,332,432}, 1.003, 0.996)
  ({"tt"}, {"2017"}, {32,132,232,332,432}, 1.004, 0.996)
  ({"tt"}, {"2018"}, {32,132,232,332,432}, 1.007, 0.993)
  );

  cb.cp().process({"qqX"}).AddSyst(cb, "CMS_htt_mistag_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
  ({"em"}, {"2016"}, {35,135,235,335,435}, 0.939, 1.09)
  ({"em"}, {"2017"}, {35,135,235,335,435}, 0.858, 1.103)
  ({"em"}, {"2018"}, {35,135,235,335,435}, 0.898, 1.125)
  ({"em"}, {"2016"}, {36,136,236,336,436}, 0.927, 1.083)
  ({"em"}, {"2017"}, {36,136,236,336,436}, 0.905, 1.117)
  ({"em"}, {"2018"}, {36,136,236,336,436}, 0.89, 1.103)
  ({"em"}, {"2016"}, {37,137,237,337,437}, 0.929, 1.068)
  ({"em"}, {"2017"}, {37,137,237,337,437}, 0.892, 1.101)
  ({"em"}, {"2018"}, {37,137,237,337,437}, 0.886, 1.119)
  ({"em"}, {"2016"}, {32,132,232,332,432}, 1.004, 0.993)
  ({"em"}, {"2017"}, {32,132,232,332,432}, 1.01, 0.991)
  ({"em"}, {"2018"}, {32,132,232,332,432}, 1.008, 0.988)
  ({"em"}, {"2016"}, {33,133,233,333,433}, 1.004, 0.994)
  ({"em"}, {"2017"}, {33,133,233,333,433}, 1.006, 0.992)
  ({"em"}, {"2018"}, {33,133,233,333,433}, 1.009, 0.992)
  ({"em"}, {"2016"}, {34,134,234,334,434}, 1.007, 0.997)
  ({"em"}, {"2017"}, {34,134,234,334,434}, 1.008, 0.994)
  ({"em"}, {"2018"}, {34,134,234,334,434}, 1.01, 0.99)
  ...
  // ({"em"}, {"2017"}, {2}, 1.0, 1.0)
  // ({"em"}, {"2018"}, {2}, 1.0, 1.0)
  ({"et"}, {"2016"}, {35,135,235,335,435}, 0.958, 1.047)
  ({"et"}, {"2017"}, {35,135,235,335,435}, 0.954, 1.046)
  ({"et"}, {"2018"}, {35,135,235,335,435}, 0.922, 1.073)
  ({"et"}, {"2016"}, {36,136,236,336,436}, 0.934, 1.038)
  ({"et"}, {"2017"}, {36,136,236,336,436}, 0.949, 1.04)
  ({"et"}, {"2018"}, {36,136,236,336,436}, 0.93, 1.08)
  ({"et"}, {"2016"}, {32,132,232,332,432}, 1.004, 0.996)
  ({"et"}, {"2017"}, {32,132,232,332,432}, 1.005, 0.995)
  ({"et"}, {"2018"}, {32,132,232,332,432}, 1.009, 0.991)
  ({"et"}, {"2016"}, {33,133,233,333,433}, 1.006, 0.996)
  ({"et"}, {"2017"}, {33,133,233,333,433}, 1.006, 0.995)
  ({"et"}, {"2018"}, {33,133,233,333,433}, 1.009, 0.99)
  ({"mt"}, {"2016"}, {35,135,235,335,435}, 0.96, 1.047)
  ({"mt"}, {"2017"}, {35,135,235,335,435}, 0.952, 1.047)
  ({"mt"}, {"2018"}, {35,135,235,335,435}, 0.926, 1.072)
  ({"mt"}, {"2016"}, {36,136,236,336,436}, 0.944, 1.06)
  ({"mt"}, {"2017"}, {36,136,236,336,436}, 0.953, 1.046)
  ({"mt"}, {"2018"}, {36,136,236,336,436}, 0.929, 1.074)
  ({"mt"}, {"2016"}, {32,132,232,332,432}, 1.004, 0.996)
  ({"mt"}, {"2017"}, {32,132,232,332,432}, 1.005, 0.995)
  ({"mt"}, {"2018"}, {32,132,232,332,432}, 1.009, 0.991)
  ({"mt"}, {"2016"}, {33,133,233,333,433}, 1.005, 0.995)
  ({"mt"}, {"2017"}, {33,133,233,333,433}, 1.005, 0.995)
  ({"mt"}, {"2018"}, {33,133,233,333,433}, 1.009, 0.991)
  ({"tt"}, {"2016"}, {35,135,235,335,435}, 0.958, 1.049)
  ({"tt"}, {"2017"}, {35,135,235,335,435}, 0.956, 1.046)
  ({"tt"}, {"2018"}, {35,135,235,335,435}, 0.929, 1.072)
  ({"tt"}, {"2016"}, {32,132,232,332,432}, 1.004, 0.995)
  ({"tt"}, {"2017"}, {32,132,232,332,432}, 1.005, 0.995)
  ({"tt"}, {"2018"}, {32,132,232,332,432}, 1.009, 0.991)
  );

  cb.cp().process(signals_qqH).AddSyst(cb, "CMS_htt_mistag_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
  ({"em"}, {"2016"}, {35,135,235,335,435}, 0.939, 1.09)
  ({"em"}, {"2017"}, {35,135,235,335,435}, 0.858, 1.103)
  ({"em"}, {"2018"}, {35,135,235,335,435}, 0.898, 1.125)
  ({"em"}, {"2016"}, {36,136,236,336,436}, 0.927, 1.083)
  ...
  ({"mt"}, {"2017"}, {33,133,233,333,433}, 1.005, 0.995)
  ({"mt"}, {"2018"}, {33,133,233,333,433}, 1.009, 0.991)
  ({"mt"}, {"2016"}, {301}, 1.004, 0.996)
  ({"mt"}, {"2016"}, {302}, 0.954, 1.047)
  ({"mt"}, {"2017"}, {301}, 1.005, 0.995)
  ({"mt"}, {"2017"}, {302}, 0.953, 1.046)
  ({"mt"}, {"2018"}, {301}, 1.009, 0.991)
  ({"mt"}, {"2018"}, {302}, 0.928, 1.071)
  ({"tt"}, {"2016"}, {35,135,235,335,435}, 0.958, 1.049)
  ({"tt"}, {"2017"}, {35,135,235,335,435}, 0.956, 1.046)
  ({"tt"}, {"2018"}, {35,135,235,335,435}, 0.929, 1.072)
  ({"tt"}, {"2016"}, {32,132,232,332,432}, 1.004, 0.995)
  ...
  cb.cp().process({"ggHWW125"}).AddSyst(cb, "CMS_htt_eff_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
     ({"em"}, {"2016"}, {35,135,235,335,435}, 1.000, 1.000)
     ({"em"}, {"2016"}, {2}, 0.992, 1.011)
     ({"em"}, {"2016"}, {36,136,236,336,436}, 0.966, 1.013)
     ({"em"}, {"2016"}, {32,132,232,332,432}, 1.000, 1.000)
     ({"em"}, {"2016"}, {33,133,233,333,433}, 1.000, 0.997)
     ({"em"}, {"2016"}, {34,134,234,334,434}, 1.000, 0.999)
     ({"em"}, {"2016"}, {37,137,237,337,437}, 0.976, 1.010)
     ({"em"}, {"2017"}, {35,135,235,335,435}, 1.000, 1.000)
     ({"em"}, {"2017"}, {2}, 0.994, 1.010)
     ({"em"}, {"2017"}, {36,136,236,336,436}, 0.990, 1.013)
     ({"em"}, {"2017"}, {32,132,232,332,432}, 1.000, 1.000)
     ({"em"}, {"2017"}, {33,133,233,333,433}, 0.999, 0.998)
     ({"em"}, {"2017"}, {34,134,234,334,434}, 0.999, 0.998)
     ({"em"}, {"2017"}, {37,137,237,337,437}, 0.981, 0.999)
     ({"em"}, {"2018"}, {35,135,235,335,435}, 0.989, 0.997)
     ({"em"}, {"2018"}, {2}, 0.997, 1.005)
     ({"em"}, {"2018"}, {36,136,236,336,436}, 0.998, 1.002)
     ({"em"}, {"2018"}, {32,132,232,332,432}, 1.001, 1.000)
     ({"em"}, {"2018"}, {33,133,233,333,433}, 1.000, 0.999)
     ({"em"}, {"2018"}, {34,134,234,334,434}, 1.000, 0.999)
     ({"em"}, {"2018"}, {37,137,237,337,437}, 0.987, 1.004)
  );

  cb.cp().process({"qqHWW125"}).AddSyst(cb, "CMS_htt_eff_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
     ({"em"}, {"2016"}, {35,135,235,335,435}, 0.994, 1.000)
     ({"em"}, {"2016"}, {2}, 0.993, 1.005)
     ({"em"}, {"2016"}, {36,136,236,336,436}, 0.999, 1.005)
     ({"em"}, {"2016"}, {32,132,232,332,432}, 0.999, 0.999)
     ({"em"}, {"2016"}, {33,133,233,333,433}, 1.000, 0.999)
     ({"em"}, {"2016"}, {34,134,234,334,434}, 1.000, 1.000)
     ({"em"}, {"2016"}, {37,137,237,337,437}, 1.000, 1.004)
     ({"em"}, {"2017"}, {35,135,235,335,435}, 0.985, 0.999)
     ({"em"}, {"2017"}, {2}, 0.991, 1.006)
     ({"em"}, {"2017"}, {36,136,236,336,436}, 0.990, 1.021)
     ({"em"}, {"2017"}, {32,132,232,332,432}, 1.000, 0.999)
     ({"em"}, {"2017"}, {33,133,233,333,433}, 1.000, 0.998)
     ({"em"}, {"2017"}, {34,134,234,334,434}, 1.000, 0.999)
     ({"em"}, {"2017"}, {37,137,237,337,437}, 0.984, 1.000)
     ({"em"}, {"2018"}, {35,135,235,335,435}, 0.998, 1.006)
     ({"em"}, {"2018"}, {2}, 0.995, 1.002)
     ({"em"}, {"2018"}, {36,136,236,336,436}, 0.988, 1.004)
     ({"em"}, {"2018"}, {32,132,232,332,432}, 0.999, 0.999)
     ({"em"}, {"2018"}, {33,133,233,333,433}, 1.001, 1.000)
     ({"em"}, {"2018"}, {34,134,234,334,434}, 1.000, 0.999)
     ({"em"}, {"2018"}, {37,137,237,337,437}, 0.989, 1.003)
  );

  cb.cp().process({"ZHWW125"}).AddSyst(cb, "CMS_htt_eff_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
     ({"em"}, {"2016"}, {35,135,235,335,435}, 1.000, 1.001)
     ({"em"}, {"2016"}, {2}, 0.989, 1.000)
     ({"em"}, {"2016"}, {36,136,236,336,436}, 1.000, 1.000)
     ({"em"}, {"2016"}, {32,132,232,332,432}, 1.000, 1.000)
     ({"em"}, {"2016"}, {33,133,233,333,433}, 1.000, 1.000)
     ({"em"}, {"2016"}, {34,134,234,334,434}, 0.994, 0.994)
     ({"em"}, {"2016"}, {37,137,237,337,437}, 1.000, 1.000)
     ({"em"}, {"2017"}, {35,135,235,335,435}, 1.000, 1.022)
     ({"em"}, {"2017"}, {2}, 0.989, 1.011)
     ({"em"}, {"2017"}, {36,136,236,336,436}, 0.984, 1.019)
     ({"em"}, {"2017"}, {32,132,232,332,432}, 1.000, 0.994)
     ({"em"}, {"2017"}, {33,133,233,333,433}, 1.001, 0.992)
     ({"em"}, {"2017"}, {34,134,234,334,434}, 1.005, 1.002)
     ({"em"}, {"2017"}, {37,137,237,337,437}, 0.991, 1.005)
     ({"em"}, {"2018"}, {35,135,235,335,435}, 0.990, 1.000)
     ({"em"}, {"2018"}, {2}, 0.992, 1.006)
     ({"em"}, {"2018"}, {36,136,236,336,436}, 1.000, 1.021)
     ({"em"}, {"2018"}, {32,132,232,332,432}, 0.999, 0.996)
     ({"em"}, {"2018"}, {33,133,233,333,433}, 1.002, 0.996)
     ({"em"}, {"2018"}, {34,134,234,334,434}, 0.998, 0.996)
     ({"em"}, {"2018"}, {37,137,237,337,437}, 1.000, 1.007)
  );

  cb.cp().process({"WHWW125"}).AddSyst(cb, "CMS_htt_eff_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
     ({"em"}, {"2016"}, {35,135,235,335,435}, 1.000, 1.032)
     ({"em"}, {"2016"}, {2}, 0.997, 1.000)
     ({"em"}, {"2016"}, {36,136,236,336,436}, 1.000, 1.000)
     ({"em"}, {"2016"}, {32,132,232,332,432}, 1.000, 0.996)
     ({"em"}, {"2016"}, {33,133,233,333,433}, 0.998, 0.998)
     ({"em"}, {"2016"}, {34,134,234,334,434}, 1.002, 1.002)
     ({"em"}, {"2016"}, {37,137,237,337,437}, 1.000, 1.000)
     ({"em"}, {"2017"}, {35,135,235,335,435}, 1.000, 1.017)
     ({"em"}, {"2017"}, {2}, 1.001, 1.003)
     ({"em"}, {"2017"}, {36,136,236,336,436}, 0.993, 1.004)
     ({"em"}, {"2017"}, {32,132,232,332,432}, 0.999, 0.997)
     ({"em"}, {"2017"}, {33,133,233,333,433}, 0.999, 0.998)
     ({"em"}, {"2017"}, {34,134,234,334,434}, 1.000, 0.999)
     ({"em"}, {"2017"}, {37,137,237,337,437}, 0.996, 1.009)
     ({"em"}, {"2018"}, {35,135,235,335,435}, 1.000, 1.018)
     ({"em"}, {"2018"}, {2}, 0.999, 1.001)
     ({"em"}, {"2018"}, {36,136,236,336,436}, 1.000, 1.004)
     ({"em"}, {"2018"}, {32,132,232,332,432}, 0.999, 0.996)
     ({"em"}, {"2018"}, {33,133,233,333,433}, 1.001, 1.000)
     ({"em"}, {"2018"}, {34,134,234,334,434}, 0.998, 0.998)
     ({"em"}, {"2018"}, {37,137,237,337,437}, 1.000, 1.001)
  );

  cb.cp().process({"ggHWW125"}).AddSyst(cb, "CMS_htt_mistag_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
     ({"em"}, {"2016"}, {35,135,235,335,435}, 0.968, 1.156)
     ({"em"}, {"2016"}, {2}, 0.915, 1.114)
     ({"em"}, {"2016"}, {36,136,236,336,436}, 0.892, 1.063)
     ({"em"}, {"2016"}, {32,132,232,332,432}, 1.003, 0.986)
     ({"em"}, {"2016"}, {33,133,233,333,433}, 1.004, 0.994)
     ({"em"}, {"2016"}, {34,134,234,334,434}, 1.002, 0.995)
     ({"em"}, {"2016"}, {37,137,237,337,437}, 0.928, 1.103)
     ({"em"}, {"2017"}, {35,135,235,335,435}, 0.887, 1.137)
     ({"em"}, {"2017"}, {2}, 0.890, 1.121)
     ({"em"}, {"2017"}, {36,136,236,336,436}, 0.894, 1.097)
     ({"em"}, {"2017"}, {32,132,232,332,432}, 1.011, 0.987)
     ({"em"}, {"2017"}, {33,133,233,333,433}, 1.005, 0.993)
     ({"em"}, {"2017"}, {34,134,234,334,434}, 1.005, 0.994)
     ({"em"}, {"2017"}, {37,137,237,337,437}, 0.864, 1.088)
     ({"em"}, {"2018"}, {35,135,235,335,435}, 0.879, 1.155)
     ({"em"}, {"2018"}, {2}, 0.865, 1.152)
     ({"em"}, {"2018"}, {36,136,236,336,436}, 0.903, 1.093)
     ({"em"}, {"2018"}, {32,132,232,332,432}, 1.013, 0.982)
     ({"em"}, {"2018"}, {33,133,233,333,433}, 1.006, 0.993)
     ({"em"}, {"2018"}, {34,134,234,334,434}, 1.007, 0.992)
     ({"em"}, {"2018"}, {37,137,237,337,437}, 0.863, 1.133)
  );

  cb.cp().process({"qqHWW125"}).AddSyst(cb, "CMS_htt_mistag_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
     ({"em"}, {"2016"}, {35,135,235,335,435}, 0.923, 1.063)
     ({"em"}, {"2016"}, {2}, 0.919, 1.078)
     ({"em"}, {"2016"}, {36,136,236,336,436}, 0.907, 1.094)
     ({"em"}, {"2016"}, {32,132,232,332,432}, 1.004, 0.994)
     ({"em"}, {"2016"}, {33,133,233,333,433}, 1.006, 0.993)
     ({"em"}, {"2016"}, {34,134,234,334,434}, 1.006, 0.996)
     ({"em"}, {"2016"}, {37,137,237,337,437}, 0.905, 1.074)
     ({"em"}, {"2017"}, {35,135,235,335,435}, 0.881, 1.102)
     ({"em"}, {"2017"}, {2}, 0.884, 1.104)
     ({"em"}, {"2017"}, {36,136,236,336,436}, 0.921, 1.095)
     ({"em"}, {"2017"}, {32,132,232,332,432}, 1.008, 0.991)
     ({"em"}, {"2017"}, {33,133,233,333,433}, 1.006, 0.992)
     ({"em"}, {"2017"}, {34,134,234,334,434}, 1.008, 0.991)
     ({"em"}, {"2017"}, {37,137,237,337,437}, 0.874, 1.100)
     ({"em"}, {"2018"}, {35,135,235,335,435}, 0.909, 1.124)
     ({"em"}, {"2018"}, {2}, 0.898, 1.112)
     ({"em"}, {"2018"}, {36,136,236,336,436}, 0.904, 1.088)
     ({"em"}, {"2018"}, {32,132,232,332,432}, 1.008, 0.988)
     ({"em"}, {"2018"}, {33,133,233,333,433}, 1.009, 0.992)
     ({"em"}, {"2018"}, {34,134,234,334,434}, 1.010, 0.991)
     ({"em"}, {"2018"}, {37,137,237,337,437}, 0.881, 1.091)
  );

  cb.cp().process({"ZHWW125"}).AddSyst(cb, "CMS_htt_mistag_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
     ({"em"}, {"2016"}, {35,135,235,335,435}, 1.000, 1.000)
     ({"em"}, {"2016"}, {2}, 0.960, 1.026)
     ({"em"}, {"2016"}, {36,136,236,336,436}, 1.000, 1.073)
     ({"em"}, {"2016"}, {32,132,232,332,432}, 1.000, 1.000)
     ({"em"}, {"2016"}, {33,133,233,333,433}, 1.000, 0.982)
     ({"em"}, {"2016"}, {34,134,234,334,434}, 1.018, 0.976)
     ({"em"}, {"2016"}, {37,137,237,337,437}, 0.892, 1.084)
     ({"em"}, {"2017"}, {35,135,235,335,435}, 0.948, 1.037)
     ({"em"}, {"2017"}, {2}, 0.952, 1.049)
     ({"em"}, {"2017"}, {36,136,236,336,436}, 0.930, 1.022)
     ({"em"}, {"2017"}, {32,132,232,332,432}, 1.014, 0.990)
     ({"em"}, {"2017"}, {33,133,233,333,433}, 1.016, 0.991)
     ({"em"}, {"2017"}, {34,134,234,334,434}, 1.012, 0.998)
     ({"em"}, {"2017"}, {37,137,237,337,437}, 0.960, 1.021)
     ({"em"}, {"2018"}, {35,135,235,335,435}, 0.935, 1.056)
     ({"em"}, {"2018"}, {2}, 0.950, 1.049)
     ({"em"}, {"2018"}, {36,136,236,336,436}, 0.914, 1.052)
     ({"em"}, {"2018"}, {32,132,232,332,432}, 1.016, 0.979)
     ({"em"}, {"2018"}, {33,133,233,333,433}, 1.029, 0.986)
     ({"em"}, {"2018"}, {34,134,234,334,434}, 1.011, 0.973)
     ({"em"}, {"2018"}, {37,137,237,337,437}, 0.947, 1.106)
  );

  cb.cp().process({"WHWW125"}).AddSyst(cb, "CMS_htt_mistag_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
     ({"em"}, {"2016"}, {35,135,235,335,435}, 0.829, 1.074)
     ({"em"}, {"2016"}, {2}, 0.882, 1.094)
     ({"em"}, {"2016"}, {36,136,236,336,436}, 0.885, 1.104)
     ({"em"}, {"2016"}, {32,132,232,332,432}, 1.021, 0.991)
     ({"em"}, {"2016"}, {33,133,233,333,433}, 1.007, 0.988)
     ({"em"}, {"2016"}, {34,134,234,334,434}, 1.011, 0.998)
     ({"em"}, {"2016"}, {37,137,237,337,437}, 0.905, 1.043)
     ({"em"}, {"2017"}, {35,135,235,335,435}, 0.905, 1.098)
     ({"em"}, {"2017"}, {2}, 0.860, 1.127)
     ({"em"}, {"2017"}, {36,136,236,336,436}, 0.868, 1.126)
     ({"em"}, {"2017"}, {32,132,232,332,432}, 1.012, 0.987)
     ({"em"}, {"2017"}, {33,133,233,333,433}, 1.013, 0.985)
     ({"em"}, {"2017"}, {34,134,234,334,434}, 1.010, 0.989)
     ({"em"}, {"2017"}, {37,137,237,337,437}, 0.892, 1.124)
     ({"em"}, {"2018"}, {35,135,235,335,435}, 0.913, 1.121)
     ({"em"}, {"2018"}, {2}, 0.876, 1.118)
     ({"em"}, {"2018"}, {36,136,236,336,436}, 0.893, 1.139)
     ({"em"}, {"2018"}, {32,132,232,332,432}, 1.013, 0.979)
     ({"em"}, {"2018"}, {33,133,233,333,433}, 1.014, 0.983)
     ({"em"}, {"2018"}, {34,134,234,334,434}, 1.013, 0.979)
     ({"em"}, {"2018"}, {37,137,237,337,437}, 0.875, 1.150)
  );

  cb.cp().process({"ZTT"}).AddSyst(cb, "CMS_htt_eff_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
  ({"em"}, {"2016"}, {35,135,235,335,435}, 0.994, 1.003)
  ({"em"}, {"2017"}, {35,135,235,335,435}, 0.98, 1.016)
  ({"em"}, {"2018"}, {35,135,235,335,435}, 0.994, 1.009)
  ({"em"}, {"2016"}, {36,136,236,336,436}, 0.989, 1.008)
  ({"em"}, {"2017"}, {36,136,236,336,436}, 0.986, 1.017)
  ({"em"}, {"2018"}, {36,136,236,336,436}, 0.988, 1.009)
  ({"em"}, {"2016"}, {37,137,237,337,437}, 0.985, 1.008)
  ({"em"}, {"2017"}, {37,137,237,337,437}, 0.981, 1.016)
  ({"em"}, {"2018"}, {37,137,237,337,437}, 0.992, 1.013)
  ({"em"}, {"2016"}, {32,132,232,332,432}, 1.0, 0.999)
  ({"em"}, {"2017"}, {32,132,232,332,432}, 1.001, 0.998)
  ({"em"}, {"2018"}, {32,132,232,332,432}, 1.0, 0.998)
  ({"em"}, {"2016"}, {33,133,233,333,433}, 1.0, 1.0)
  ({"em"}, {"2017"}, {33,133,233,333,433}, 1.0, 0.999)
  ({"em"}, {"2018"}, {33,133,233,333,433}, 1.0, 0.999)
  ({"em"}, {"2016"}, {34,134,234,334,434}, 1.001, 1.0)
  ({"em"}, {"2017"}, {34,134,234,334,434}, 1.001, 1.0)
  ({"em"}, {"2018"}, {34,134,234,334,434}, 1.001, 1.0)
  ({"em"}, {"2016"}, {2}, 1.001, 1.001)
  ({"em"}, {"2017"}, {2}, 1.001, 1.001)
  ({"em"}, {"2018"}, {2}, 1.001, 1.001)
  ({"et"}, {"2016"}, {35,135,235,335,435}, 0.975, 1.026)
  ({"et"}, {"2017"}, {35,135,235,335,435}, 0.966, 1.036)
  ({"et"}, {"2018"}, {35,135,235,335,435}, 0.975, 1.026)
  ({"et"}, {"2016"}, {36,136,236,336,436}, 0.981, 1.027)
  ({"et"}, {"2017"}, {36,136,236,336,436}, 0.973, 1.041)
  ({"et"}, {"2018"}, {36,136,236,336,436}, 0.977, 1.032)
  ({"et"}, {"2016"}, {32,132,232,332,432}, 1.001, 0.999)
  ({"et"}, {"2017"}, {32,132,232,332,432}, 1.002, 0.998)
  ({"et"}, {"2018"}, {32,132,232,332,432}, 1.002, 0.998)
  ({"et"}, {"2016"}, {33,133,233,333,433}, 1.001, 0.999)
  ({"et"}, {"2017"}, {33,133,233,333,433}, 1.002, 0.997)
  ({"et"}, {"2018"}, {33,133,233,333,433}, 1.002, 0.997)
  ({"mt"}, {"2016"}, {35,135,235,335,435}, 0.977, 1.022)
  ({"mt"}, {"2017"}, {35,135,235,335,435}, 0.964, 1.041)
  ({"mt"}, {"2018"}, {35,135,235,335,435}, 0.974, 1.025)
  ({"mt"}, {"2016"}, {36,136,236,336,436}, 0.981, 1.018)
  ({"mt"}, {"2017"}, {36,136,236,336,436}, 0.955, 1.04)
  ({"mt"}, {"2018"}, {36,136,236,336,436}, 0.981, 1.025)
  ({"mt"}, {"2016"}, {32,132,232,332,432}, 1.001, 0.999)
  ({"mt"}, {"2017"}, {32,132,232,332,432}, 1.002, 0.998)
  ({"mt"}, {"2018"}, {32,132,232,332,432}, 1.001, 0.999)
  ({"mt"}, {"2016"}, {33,133,233,333,433}, 1.001, 0.999)
  ({"mt"}, {"2017"}, {33,133,233,333,433}, 1.003, 0.997)
  ({"mt"}, {"2018"}, {33,133,233,333,433}, 1.002, 0.998)
  ({"tt"}, {"2016"}, {35,135,235,335,435}, 0.975, 1.019)
  ({"tt"}, {"2017"}, {35,135,235,335,435}, 0.963, 1.039)
  ({"tt"}, {"2018"}, {35,135,235,335,435}, 0.917, 1.070)
  ({"tt"}, {"2016"}, {32,132,232,332,432}, 1.002, 0.999)
  ({"tt"}, {"2017"}, {32,132,232,332,432}, 1.003, 0.997)
  ({"tt"}, {"2018"}, {32,132,232,332,432}, 1.001, 0.998)
  );


  cb.cp().process({"TTT"}).AddSyst(cb, "CMS_htt_eff_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
  ({"em"}, {"2016"}, {35,135,235,335,435}, 0.99, 1.009)
  ({"em"}, {"2017"}, {35,135,235,335,435}, 0.984, 1.017)
  ({"em"}, {"2018"}, {35,135,235,335,435}, 0.989, 1.01)
  ({"em"}, {"2016"}, {36,136,236,336,436}, 0.99, 1.01)
  ({"em"}, {"2017"}, {36,136,236,336,436}, 0.986, 1.013)
  ({"em"}, {"2018"}, {36,136,236,336,436}, 0.99, 1.008)
  ({"em"}, {"2016"}, {37,137,237,337,437}, 0.991, 1.013)
  ({"em"}, {"2017"}, {37,137,237,337,437}, 0.977, 1.022)
  ({"em"}, {"2018"}, {37,137,237,337,437}, 0.99, 1.01)
  ({"em"}, {"2016"}, {32,132,232,332,432}, 1.062, 0.947)
  ({"em"}, {"2017"}, {32,132,232,332,432}, 1.104, 0.888)
  ({"em"}, {"2018"}, {32,132,232,332,432}, 1.088, 0.906)
  ({"em"}, {"2016"}, {33,133,233,333,433}, 1.048, 0.94)
  ({"em"}, {"2017"}, {33,133,233,333,433}, 1.063, 0.919)
  ({"em"}, {"2018"}, {33,133,233,333,433}, 1.078, 0.937)
  ({"em"}, {"2016"}, {34,134,234,334,434}, 1.048, 0.939)
  ({"em"}, {"2017"}, {34,134,234,334,434}, 1.131, 0.888)
  ({"em"}, {"2018"}, {34,134,234,334,434}, 1.08, 0.926)
  ({"em"}, {"2016"}, {2}, 1.0, 1.0)
  ({"em"}, {"2017"}, {2}, 1.001, 1.001)
  ({"em"}, {"2018"}, {2}, 1.0, 1.0)
  ({"et"}, {"2016"}, {35,135,235,335,435}, 0.992, 1.01)
  ({"et"}, {"2017"}, {35,135,235,335,435}, 0.972, 1.017)
  ({"et"}, {"2018"}, {35,135,235,335,435}, 0.988, 1.011)
  ({"et"}, {"2016"}, {36,136,236,336,436}, 0.986, 1.004)
  ({"et"}, {"2017"}, {36,136,236,336,436}, 0.976, 1.019)
  ({"et"}, {"2018"}, {36,136,236,336,436}, 0.988, 1.01)
  ({"et"}, {"2016"}, {32,132,232,332,432}, 1.04, 0.948)
  ({"et"}, {"2017"}, {32,132,232,332,432}, 1.177, 0.89)
  ({"et"}, {"2018"}, {32,132,232,332,432}, 1.086, 0.92)
  ({"et"}, {"2016"}, {33,133,233,333,433}, 1.074, 0.979)
  ({"et"}, {"2017"}, {33,133,233,333,433}, 1.132, 0.9)
  ({"et"}, {"2018"}, {33,133,233,333,433}, 1.085, 0.928)
  ({"mt"}, {"2016"}, {35,135,235,335,435}, 0.989, 1.011)
  ({"mt"}, {"2017"}, {35,135,235,335,435}, 0.984, 1.014)
  ({"mt"}, {"2018"}, {35,135,235,335,435}, 0.991, 1.009)
  ({"mt"}, {"2016"}, {36,136,236,336,436}, 0.989, 1.012)
  ({"mt"}, {"2017"}, {36,136,236,336,436}, 0.984, 1.017)
  ({"mt"}, {"2018"}, {36,136,236,336,436}, 0.99, 1.009)
  ({"mt"}, {"2016"}, {32,132,232,332,432}, 1.059, 0.943)
  ({"mt"}, {"2017"}, {32,132,232,332,432}, 1.104, 0.908)
  ({"mt"}, {"2018"}, {32,132,232,332,432}, 1.071, 0.931)
  ({"mt"}, {"2016"}, {33,133,233,333,433}, 1.051, 0.942)
  ({"mt"}, {"2017"}, {33,133,233,333,433}, 1.099, 0.893)
  ({"mt"}, {"2018"}, {33,133,233,333,433}, 1.077, 0.929)
  ({"tt"}, {"2016"}, {35,135,235,335,435}, 0.985, 1.015)
  ({"tt"}, {"2017"}, {35,135,235,335,435}, 0.978, 1.018)
  ({"tt"}, {"2018"}, {35,135,235,335,435}, 0.990, 1.009)
  ({"tt"}, {"2016"}, {32,132,232,332,432}, 1.066, 0.932)
  ({"tt"}, {"2017"}, {32,132,232,332,432}, 1.137, 0.889)
  ({"tt"}, {"2018"}, {32,132,232,332,432}, 1.076, 0.926)
  );

  cb.cp().process({"VVT"}).AddSyst(cb, "CMS_htt_eff_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
  ({"em"}, {"2016"}, {35,135,235,335,435}, 0.991, 1.009)
  ({"em"}, {"2017"}, {35,135,235,335,435}, 0.98, 1.023)
  ({"em"}, {"2018"}, {35,135,235,335,435}, 0.99, 1.002)
  ({"em"}, {"2016"}, {36,136,236,336,436}, 0.999, 1.013)
  ({"em"}, {"2017"}, {36,136,236,336,436}, 0.989, 1.027)
  ({"em"}, {"2018"}, {36,136,236,336,436}, 0.986, 1.01)
  ({"em"}, {"2016"}, {37,137,237,337,437}, 0.988, 1.007)
  ({"em"}, {"2017"}, {37,137,237,337,437}, 0.981, 1.021)
  ({"em"}, {"2018"}, {37,137,237,337,437}, 0.99, 1.021)
  ({"em"}, {"2016"}, {32,132,232,332,432}, 1.005, 0.995)
  ({"em"}, {"2017"}, {32,132,232,332,432}, 1.006, 0.981)
  ({"em"}, {"2018"}, {32,132,232,332,432}, 1.005, 0.998)
  ({"em"}, {"2016"}, {33,133,233,333,433}, 1.0, 0.996)
  ({"em"}, {"2017"}, {33,133,233,333,433}, 1.005, 0.992)
  ({"em"}, {"2018"}, {33,133,233,333,433}, 1.006, 0.996)
  ({"em"}, {"2016"}, {34,134,234,334,434}, 1.004, 0.999)
  ({"em"}, {"2017"}, {34,134,234,334,434}, 1.007, 0.995)
  ({"em"}, {"2018"}, {34,134,234,334,434}, 1.003, 0.992)
  ({"em"}, {"2016"}, {2}, 1.0, 1.0)
  ({"em"}, {"2017"}, {2}, 1.0, 1.0)
  ({"em"}, {"2018"}, {2}, 1.0, 1.0)
  ({"et"}, {"2016"}, {35,135,235,335,435}, 0.986, 1.029)
  ({"et"}, {"2017"}, {35,135,235,335,435}, 0.968, 1.043)
  ({"et"}, {"2018"}, {35,135,235,335,435}, 0.98, 1.019)
  ({"et"}, {"2016"}, {36,136,236,336,436}, 0.988, 1.016)
  ({"et"}, {"2017"}, {36,136,236,336,436}, 0.971, 1.036)
  ({"et"}, {"2018"}, {36,136,236,336,436}, 0.99, 1.015)
  ({"et"}, {"2016"}, {32,132,232,332,432}, 1.003, 0.993)
  ({"et"}, {"2017"}, {32,132,232,332,432}, 1.013, 0.983)
  ({"et"}, {"2018"}, {32,132,232,332,432}, 1.007, 0.993)
  ({"et"}, {"2016"}, {33,133,233,333,433}, 1.004, 0.995)
  ({"et"}, {"2017"}, {33,133,233,333,433}, 1.016, 0.981)
  ({"et"}, {"2018"}, {33,133,233,333,433}, 1.004, 0.993)
  ({"mt"}, {"2016"}, {35,135,235,335,435}, 0.978, 1.023)
  ({"mt"}, {"2017"}, {35,135,235,335,435}, 0.962, 1.036)
  ({"mt"}, {"2018"}, {35,135,235,335,435}, 0.978, 1.023)
  ({"mt"}, {"2016"}, {36,136,236,336,436}, 0.984, 1.017)
  ({"mt"}, {"2017"}, {36,136,236,336,436}, 0.982, 1.028)
  ({"mt"}, {"2018"}, {36,136,236,336,436}, 0.984, 1.015)
  ({"mt"}, {"2016"}, {32,132,232,332,432}, 1.005, 0.994)
  ({"mt"}, {"2017"}, {32,132,232,332,432}, 1.014, 0.987)
  ({"mt"}, {"2018"}, {32,132,232,332,432}, 1.007, 0.992)
  ({"mt"}, {"2016"}, {33,133,233,333,433}, 1.004, 0.995)
  ({"mt"}, {"2017"}, {33,133,233,333,433}, 1.009, 0.986)
  ({"mt"}, {"2018"}, {33,133,233,333,433}, 1.007, 0.994)
  ({"tt"}, {"2016"}, {35,135,235,335,435}, 0.977, 1.022)
  ({"tt"}, {"2017"}, {35,135,235,335,435}, 0.974, 1.022)
  ({"tt"}, {"2018"}, {35,135,235,335,435}, 0.975, 1.013)
  ({"tt"}, {"2016"}, {32,132,232,332,432}, 1.007, 0.993)
  ({"tt"}, {"2017"}, {32,132,232,332,432}, 1.013, 0.989)
  ({"tt"}, {"2018"}, {32,132,232,332,432}, 1.011, 0.994)
  );

  cb.cp().process({"ZTT"}).AddSyst(cb, "CMS_htt_mistag_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
  ({"em"}, {"2016"}, {35,135,235,335,435}, 0.946, 1.083)
  ({"em"}, {"2017"}, {35,135,235,335,435}, 0.924, 1.081)
  ({"em"}, {"2018"}, {35,135,235,335,435}, 0.904, 1.099)
  ({"em"}, {"2016"}, {36,136,236,336,436}, 0.927, 1.079)
  ({"em"}, {"2017"}, {36,136,236,336,436}, 0.926, 1.084)
  ({"em"}, {"2018"}, {36,136,236,336,436}, 0.889, 1.11)
  ({"em"}, {"2016"}, {37,137,237,337,437}, 0.934, 1.075)
  ({"em"}, {"2017"}, {37,137,237,337,437}, 0.931, 1.092)
  ({"em"}, {"2018"}, {37,137,237,337,437}, 0.911, 1.101)
  ({"em"}, {"2016"}, {32,132,232,332,432}, 1.004, 0.993)
  ({"em"}, {"2017"}, {32,132,232,332,432}, 1.007, 0.992)
  ({"em"}, {"2018"}, {32,132,232,332,432}, 1.01, 0.988)
  ({"em"}, {"2016"}, {33,133,233,333,433}, 1.002, 0.998)
  ({"em"}, {"2017"}, {33,133,233,333,433}, 1.002, 0.997)
  ({"em"}, {"2018"}, {33,133,233,333,433}, 1.005, 0.995)
  ({"em"}, {"2016"}, {34,134,234,334,434}, 1.002, 0.998)
  ({"em"}, {"2017"}, {34,134,234,334,434}, 1.003, 0.996)
  ({"em"}, {"2018"}, {34,134,234,334,434}, 1.005, 0.995)
  ({"em"}, {"2016"}, {2}, 1.001, 1.001)
  ({"em"}, {"2017"}, {2}, 1.001, 1.001)
  ({"em"}, {"2018"}, {2}, 1.001, 1.001)
  ({"et"}, {"2016"}, {35,135,235,335,435}, 0.95, 1.064)
  ({"et"}, {"2017"}, {35,135,235,335,435}, 0.946, 1.062)
  ({"et"}, {"2018"}, {35,135,235,335,435}, 0.901, 1.077)
  ({"et"}, {"2016"}, {36,136,236,336,436}, 0.949, 1.034)
  ({"et"}, {"2017"}, {36,136,236,336,436}, 0.944, 1.043)
  ({"et"}, {"2018"}, {36,136,236,336,436}, 0.921, 1.078)
  ({"et"}, {"2016"}, {32,132,232,332,432}, 1.002, 0.998)
  ({"et"}, {"2017"}, {32,132,232,332,432}, 1.003, 0.997)
  ({"et"}, {"2018"}, {32,132,232,332,432}, 1.006, 0.995)
  ({"et"}, {"2016"}, {33,133,233,333,433}, 1.003, 0.998)
  ({"et"}, {"2017"}, {33,133,233,333,433}, 1.004, 0.997)
  ({"et"}, {"2018"}, {33,133,233,333,433}, 1.006, 0.994)
  ({"mt"}, {"2016"}, {35,135,235,335,435}, 0.943, 1.061)
  ({"mt"}, {"2017"}, {35,135,235,335,435}, 0.942, 1.051)
  ({"mt"}, {"2018"}, {35,135,235,335,435}, 0.915, 1.089)
  ({"mt"}, {"2016"}, {36,136,236,336,436}, 0.959, 1.063)
  ({"mt"}, {"2017"}, {36,136,236,336,436}, 0.928, 1.052)
  ({"mt"}, {"2018"}, {36,136,236,336,436}, 0.916, 1.07)
  ({"mt"}, {"2016"}, {32,132,232,332,432}, 1.002, 0.998)
  ({"mt"}, {"2017"}, {32,132,232,332,432}, 1.003, 0.998)
  ({"mt"}, {"2018"}, {32,132,232,332,432}, 1.004, 0.996)
  ({"mt"}, {"2016"}, {33,133,233,333,433}, 1.002, 0.997)
  ({"mt"}, {"2017"}, {33,133,233,333,433}, 1.005, 0.996)
  ({"mt"}, {"2018"}, {33,133,233,333,433}, 1.007, 0.994)
  ({"tt"}, {"2016"}, {35,135,235,335,435}, 0.958, 1.049)
  ({"tt"}, {"2017"}, {35,135,235,335,435}, 0.949, 1.045)
  ({"tt"}, {"2018"}, {35,135,235,335,435}, 0.917, 1.0695)
  ({"tt"}, {"2016"}, {32,132,232,332,432}, 1.003, 0.997)
  ({"tt"}, {"2017"}, {32,132,232,332,432}, 1.004, 0.996)
  ({"tt"}, {"2018"}, {32,132,232,332,432}, 1.008, 0.994)
  );

  cb.cp().process({"TTT"}).AddSyst(cb, "CMS_htt_mistag_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
  ({"em"}, {"2016"}, {35,135,235,335,435}, 0.999, 1.001)
  ({"em"}, {"2017"}, {35,135,235,335,435}, 1.0, 1.001)
  ({"em"}, {"2018"}, {35,135,235,335,435}, 0.998, 1.001)
  ({"em"}, {"2016"}, {36,136,236,336,436}, 0.999, 1.0)
  ({"em"}, {"2017"}, {36,136,236,336,436}, 0.999, 1.001)
  ({"em"}, {"2018"}, {36,136,236,336,436}, 0.999, 1.002)
  ({"em"}, {"2016"}, {37,137,237,337,437}, 1.0, 1.001)
  ({"em"}, {"2017"}, {37,137,237,337,437}, 0.999, 1.0)
  ({"em"}, {"2018"}, {37,137,237,337,437}, 0.998, 1.001)
  ({"em"}, {"2016"}, {32,132,232,332,432}, 1.006, 0.994)
  ({"em"}, {"2017"}, {32,132,232,332,432}, 1.0, 0.996)
  ({"em"}, {"2018"}, {32,132,232,332,432}, 1.015, 0.99)
  ({"em"}, {"2016"}, {33,133,233,333,433}, 1.003, 0.996)
  ({"em"}, {"2017"}, {33,133,233,333,433}, 0.994, 0.985)
  ({"em"}, {"2018"}, {33,133,233,333,433}, 1.007, 0.985)
  ({"em"}, {"2016"}, {34,134,234,334,434}, 1.002, 0.995)
  ({"em"}, {"2017"}, {34,134,234,334,434}, 1.008, 1.003)
  ({"em"}, {"2018"}, {34,134,234,334,434}, 1.02, 0.993)
  ({"em"}, {"2016"}, {2}, 1.0, 1.0)
  ({"em"}, {"2017"}, {2}, 1.001, 1.001)
  ({"em"}, {"2018"}, {2}, 1.0, 1.0)
  ({"et"}, {"2016"}, {35,135,235,335,435}, 1.0, 1.0)
  ({"et"}, {"2017"}, {35,135,235,335,435}, 1.0, 1.0)
  ({"et"}, {"2018"}, {35,135,235,335,435}, 0.999, 1.001)
  ({"et"}, {"2016"}, {36,136,236,336,436}, 0.997, 1.001)
  ({"et"}, {"2017"}, {36,136,236,336,436}, 0.995, 1.002)
  ({"et"}, {"2018"}, {36,136,236,336,436}, 0.998, 1.001)
  ({"et"}, {"2016"}, {32,132,232,332,432}, 1.0, 1.0)
  ({"et"}, {"2017"}, {32,132,232,332,432}, 1.0, 1.0)
  ({"et"}, {"2018"}, {32,132,232,332,432}, 1.009, 0.992)
  ({"et"}, {"2016"}, {33,133,233,333,433}, 1.014, 0.994)
  ({"et"}, {"2017"}, {33,133,233,333,433}, 1.029, 0.991)
  ({"et"}, {"2018"}, {33,133,233,333,433}, 1.015, 0.991)
  ({"mt"}, {"2016"}, {35,135,235,335,435}, 1.0, 1.001)
  ({"mt"}, {"2017"}, {35,135,235,335,435}, 0.999, 1.001)
  ({"mt"}, {"2018"}, {35,135,235,335,435}, 0.999, 1.001)
  ({"mt"}, {"2016"}, {36,136,236,336,436}, 0.999, 1.0)
  ({"mt"}, {"2017"}, {36,136,236,336,436}, 0.999, 1.001)
  ({"mt"}, {"2018"}, {36,136,236,336,436}, 0.999, 1.001)
  ({"mt"}, {"2016"}, {32,132,232,332,432}, 1.001, 0.995)
  ({"mt"}, {"2017"}, {32,132,232,332,432}, 1.009, 0.996)
  ({"mt"}, {"2018"}, {32,132,232,332,432}, 1.008, 0.993)
  ({"mt"}, {"2016"}, {33,133,233,333,433}, 1.003, 1.0)
  ({"mt"}, {"2017"}, {33,133,233,333,433}, 1.005, 0.997)
  ({"mt"}, {"2018"}, {33,133,233,333,433}, 1.01, 0.992)
  ({"tt"}, {"2016"}, {35,135,235,335,435}, 0.998, 1.002)
  ({"tt"}, {"2017"}, {35,135,235,335,435}, 0.999, 1.001)
  ({"tt"}, {"2018"}, {35,135,235,335,435}, 0.999, 1.001)
  ({"tt"}, {"2016"}, {32,132,232,332,432}, 1.009, 0.991)
  ({"tt"}, {"2017"}, {32,132,232,332,432}, 1.005, 0.995)
  ({"tt"}, {"2018"}, {32,132,232,332,432}, 1.009, 0.990)
  );

  cb.cp().process({"VVT"}).AddSyst(cb, "CMS_htt_mistag_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
  ({"em"}, {"2016"}, {35,135,235,335,435}, 0.986, 1.015)
  ({"em"}, {"2017"}, {35,135,235,335,435}, 0.974, 1.011)
  ({"em"}, {"2018"}, {35,135,235,335,435}, 0.963, 1.027)
  ({"em"}, {"2016"}, {36,136,236,336,436}, 0.975, 1.026)
  ({"em"}, {"2017"}, {36,136,236,336,436}, 0.979, 1.034)
  ({"em"}, {"2018"}, {36,136,236,336,436}, 0.969, 1.042)
  ({"em"}, {"2016"}, {37,137,237,337,437}, 0.991, 1.005)
  ({"em"}, {"2017"}, {37,137,237,337,437}, 0.979, 1.04)
  ({"em"}, {"2018"}, {37,137,237,337,437}, 0.976, 1.034)
  ({"em"}, {"2016"}, {32,132,232,332,432}, 1.008, 0.991)
  ({"em"}, {"2017"}, {32,132,232,332,432}, 1.01, 0.988)
  ({"em"}, {"2018"}, {32,132,232,332,432}, 1.021, 0.983)
  ({"em"}, {"2016"}, {33,133,233,333,433}, 1.007, 0.992)
  ({"em"}, {"2017"}, {33,133,233,333,433}, 1.009, 0.989)
  ({"em"}, {"2018"}, {33,133,233,333,433}, 1.012, 0.984)
  ({"em"}, {"2016"}, {34,134,234,334,434}, 1.003, 0.999)
  ({"em"}, {"2017"}, {34,134,234,334,434}, 1.007, 0.989)
  ({"em"}, {"2018"}, {34,134,234,334,434}, 1.008, 0.988)
  ({"em"}, {"2016"}, {2}, 1.0, 1.0)
  ({"em"}, {"2017"}, {2}, 1.0, 1.0)
  ({"em"}, {"2018"}, {2}, 1.0, 1.0)
  ({"et"}, {"2016"}, {35,135,235,335,435}, 0.977, 1.015)
  ({"et"}, {"2017"}, {35,135,235,335,435}, 0.988, 1.019)
  ({"et"}, {"2018"}, {35,135,235,335,435}, 0.969, 1.033)
  ({"et"}, {"2016"}, {36,136,236,336,436}, 0.993, 1.018)
  ({"et"}, {"2017"}, {36,136,236,336,436}, 0.99, 1.004)
  ({"et"}, {"2018"}, {36,136,236,336,436}, 0.969, 1.016)
  ({"et"}, {"2016"}, {32,132,232,332,432}, 1.006, 0.996)
  ({"et"}, {"2017"}, {32,132,232,332,432}, 1.005, 0.993)
  ({"et"}, {"2018"}, {32,132,232,332,432}, 1.011, 0.988)
  ({"et"}, {"2016"}, {33,133,233,333,433}, 1.002, 0.994)
  ({"et"}, {"2017"}, {33,133,233,333,433}, 1.005, 0.998)
  ({"et"}, {"2018"}, {33,133,233,333,433}, 1.013, 0.993)
  ({"mt"}, {"2016"}, {35,135,235,335,435}, 0.986, 1.013)
  ({"mt"}, {"2017"}, {35,135,235,335,435}, 0.982, 1.012)
  ({"mt"}, {"2018"}, {35,135,235,335,435}, 0.969, 1.031)
  ({"mt"}, {"2016"}, {36,136,236,336,436}, 0.998, 1.02)
  ({"mt"}, {"2017"}, {36,136,236,336,436}, 0.993, 1.006)
  ({"mt"}, {"2018"}, {36,136,236,336,436}, 0.983, 1.02)
  ({"mt"}, {"2016"}, {32,132,232,332,432}, 1.003, 0.997)
  ({"mt"}, {"2017"}, {32,132,232,332,432}, 1.006, 0.996)
  ({"mt"}, {"2018"}, {32,132,232,332,432}, 1.01, 0.99)
  ({"mt"}, {"2016"}, {33,133,233,333,433}, 1.001, 0.994)
  ({"mt"}, {"2017"}, {33,133,233,333,433}, 1.004, 0.997)
  ({"mt"}, {"2018"}, {33,133,233,333,433}, 1.007, 0.991)
  ({"tt"}, {"2016"}, {35,135,235,335,435}, 0.985, 1.008)
  ({"tt"}, {"2017"}, {35,135,235,335,435}, 0.992, 1.008)
  ({"tt"}, {"2018"}, {35,135,235,335,435}, 0.979, 1.021)
  ({"tt"}, {"2016"}, {32,132,232,332,432}, 1.005, 0.998)
  ({"tt"}, {"2017"}, {32,132,232,332,432}, 1.004, 0.996)
  ({"tt"}, {"2018"}, {32,132,232,332,432}, 1.010, 0.991)
  );
  ...
  if (not sm){
    ...
    std::string masses[32] = {"60","80","95","100","120","125","130","140","160","180","200","250","300","350","400","450","500","600","700","800","900","1000","1200","1400","1600","1800","2000","2300","2600","2900","3200","3500"};
