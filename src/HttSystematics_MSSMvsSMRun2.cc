...
void AddMSSMvsSMRun2Systematics(CombineHarvester &cb, bool jetfakes, bool embedding, bool regional_jec, bool ggh_wg1, bool qqh_wg1, int era, bool mva, bool sm) {
 ...
 if (!sm) {
  ...
  cb.cp().process(mc_processes).AddSyst(cb, "CMS_htt_eff_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
     ({"em"}, {"2016"}, btag_catagories, 0.9914, 1.0066)
     ({"em"}, {"2016"}, nobtag_catagories, 1.0206, 0.9786)
     ({"em"}, {"2017"}, btag_catagories, 0.9816, 1.0115)
     ({"em"}, {"2017"}, nobtag_catagories, 1.0385, 0.9617)
     ({"em"}, {"2018"}, btag_catagories, 0.985, 1.0126)
     ({"em"}, {"2018"}, nobtag_catagories, 1.0222, 0.9771)
     ({"mt"}, {"2017"}, nobtag_catagories, 1.073, 0.931)
     ({"mt"}, {"2017"}, btag_catagories, 0.9807, 1.0183)
     ({"mt"}, {"2016"}, nobtag_catagories, 1.016, 0.9658)
     ({"mt"}, {"2016"}, btag_catagories, 0.9658, 1.0)
     ({"mt"}, {"2018"}, nobtag_catagories, 1.0425, 0.9608)
     ({"mt"}, {"2018"}, btag_catagories, 0.9895, 1.0097)
     ({"tt"}, {"2017"}, nobtag_catagories, 1.0348, 0.9345)
     ({"tt"}, {"2017"}, btag_catagories, 0.9907, 1.0172)
     ({"tt"}, {"2016"}, nobtag_catagories, 1.0138, 0.9784)
     ({"tt"}, {"2016"}, btag_catagories, 0.9692, 1.0)
     ({"tt"}, {"2018"}, nobtag_catagories, 1.0417, 0.9732)
     ({"tt"}, {"2018"}, btag_catagories, 0.9881, 1.0077)
     ({"et"}, {"2017"}, nobtag_catagories, 1.0745, 0.9323)
     ({"et"}, {"2017"}, btag_catagories, 0.98, 1.0181)
     ({"et"}, {"2016"}, nobtag_catagories, 1.0165, 0.9636)
     ({"et"}, {"2016"}, btag_catagories, 0.964, 1.0)
     ({"et"}, {"2018"}, nobtag_catagories, 1.0416, 0.9611)
     ({"et"}, {"2018"}, btag_catagories, 0.9897, 1.0096));


  cb.cp().process(mc_processes).AddSyst(cb, "CMS_htt_mistag_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
     ({"em"}, {"2016"}, btag_catagories, 0.9982, 1.0000)
     ({"em"}, {"2016"}, nobtag_catagories, 1.0039, 0.9961)
     ({"em"}, {"2017"}, btag_catagories, 0.997, 1.0014)
     ({"em"}, {"2017"}, nobtag_catagories, 1.0049, 0.9947)
     ({"em"}, {"2018"}, btag_catagories, 0.9957, 1.0039)
     ({"em"}, {"2018"}, nobtag_catagories, 1.0065, 0.9931)
     ({"mt"}, {"2017"}, nobtag_catagories, 1.0045, 0.9953)
     ({"mt"}, {"2017"}, btag_catagories, 0.9988, 1.0012)
     ({"mt"}, {"2016"}, nobtag_catagories, 0.9932, 1.0)
     ({"mt"}, {"2016"}, btag_catagories, 0.9755, 1.0)
     ({"mt"}, {"2018"}, nobtag_catagories, 1.0079, 0.9924)
     ({"mt"}, {"2018"}, btag_catagories, 0.998, 1.0019)
     ({"tt"}, {"2017"}, nobtag_catagories, 1.0, 1.0005)
     ({"tt"}, {"2017"}, btag_catagories, 1.0, 0.9998)
     ({"tt"}, {"2016"}, nobtag_catagories, 0.9924, 1.0)
     ({"tt"}, {"2016"}, btag_catagories, 1.0, 0.9795)
     ({"tt"}, {"2018"}, nobtag_catagories, 1.0077, 0.9923)
     ({"tt"}, {"2018"}, btag_catagories, 0.9978, 1.0022)
     ({"et"}, {"2017"}, nobtag_catagories, 1.0044, 0.9952)
     ({"et"}, {"2017"}, btag_catagories, 0.9988, 1.0013)
     ({"et"}, {"2016"}, nobtag_catagories, 0.9925, 1.0)
     ({"et"}, {"2016"}, btag_catagories, 1.0, 0.9773)
     ({"et"}, {"2018"}, nobtag_catagories, 1.0081, 0.9921)
     ({"et"}, {"2018"}, btag_catagories, 0.998, 1.002));
