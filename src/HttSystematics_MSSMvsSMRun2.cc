...
void AddMSSMvsSMRun2Systematics(CombineHarvester &cb, bool jetfakes, bool embedding, bool regional_jec, bool ggh_wg1, bool qqh_wg1, int era, bool mva, bool sm) {
 ...
 cb.cp().process(signals_ggH).process({"ggX"}, false).AddSyst(cb, "CMS_htt_eff_b_$ERA", "lnN", SystMapAsymm<channel,ch::syst::era,bin_id>::init
  ...
  ({"tt"}, {"2016"}, {32}, 0.975, 1.019)
  ({"tt"}, {"2017"}, {32}, 0.963, 1.039)
  ({"tt"}, {"2018"}, {32}, 1.147, 2.05)
  ({"tt"}, {"2016"}, {35}, 1.002, 0.999)
  ({"tt"}, {"2017"}, {35}, 1.003, 0.997)
  ({"tt"}, {"2018"}, {35}, 1.063, 1.995)
  );
  ...
  ({"tt"}, {"2016"}, {32}, 0.985, 1.015)
  ({"tt"}, {"2017"}, {32}, 0.978, 1.018)
  ({"tt"}, {"2018"}, {32}, 1.98, 2.02)
  ({"tt"}, {"2016"}, {35}, 1.066, 0.932)
  ({"tt"}, {"2017"}, {35}, 1.137, 0.889)
  ({"tt"}, {"2018"}, {35}, 2.149, 1.848)
  );
  ...
  ({"tt"}, {"2016"}, {32}, 0.977, 1.022)
  ({"tt"}, {"2017"}, {32}, 0.974, 1.022)
  ({"tt"}, {"2018"}, {32}, 1.464, 1.856)
  ({"tt"}, {"2016"}, {35}, 1.007, 0.993)
  ...
  ({"tt"}, {"2017"}, {32}, 0.949, 1.045)
  ({"tt"}, {"2018"}, {32}, 1.834, 1.633)
  ({"tt"}, {"2016"}, {35}, 1.003, 0.997)
  ({"tt"}, {"2017"}, {35}, 1.004, 0.996)
  ({"tt"}, {"2018"}, {35}, 2.015, 1.28)
  );
  ...
  ({"tt"}, {"2016"}, {32}, 0.998, 1.002)
  ({"tt"}, {"2017"}, {32}, 0.999, 1.001)
  ({"tt"}, {"2018"}, {32}, 1.998, 2.003)
  ({"tt"}, {"2016"}, {35}, 1.009, 0.991)
  ({"tt"}, {"2017"}, {35}, 1.005, 0.995)
  ({"tt"}, {"2018"}, {35}, 2.017, 1.98)
  );
  ...
  ({"tt"}, {"2016"}, {32}, 0.985, 1.008)
  ({"tt"}, {"2017"}, {32}, 0.992, 1.008)
  ({"tt"}, {"2018"}, {32}, 1.589, 1.667)
  ({"tt"}, {"2016"}, {35}, 1.005, 0.998)
  ({"tt"}, {"2017"}, {35}, 1.004, 0.996)
  ({"tt"}, {"2018"}, {35}, 1.675, 1.803)
  );
